...
אם רוכשים תוכנה יקרה מטעם ארגון, לעיתים קרובות ישנם שלבים ותהליכים רבים שיש לשקול, המתמקדים בעיקר בתקציב. שיקולים אלה הם מחוץ לתחום הקורס הזה. במקום זאת, אנחנו ניתמקד בהיבטים הספציפיים הקשורים לאבטחה.
...
5. **האם קל להשתמש בצורה מאובטחת?**
    ...
    3. האם יש הדרכה כיצד להשתמש בצורה מאובטחת?
...
3. *צפו* לעדכון התוכנות אשר בשימוש, עד רמת הפלטפורמה הבסיסית ביותר. זה טיפשי להניח שלעולם לא יהיה צורך לעדכן את התוכנה במהירות.
...
\>\>תוכנה בשימוש חוזר הוא כל כך מסוכן, שתמיד צריך להעדיף לשכתב את התוכנה בעצמך כאשר הדבר אפשרי. אמת או שקר?<<
