...
1. פיתוח תוכנה מאובטח - חלק א', דרישות, תכנון ושימוש חוזר [מכסה את היסודות, הדרישות, העיצוב, השימוש החוזר] - ~  קורס של 2-4 שעות בלבד, ~ 4-5 שעות סה"כ כולל בדיקות וחקירת המשאבים/קישורים שסופקו
