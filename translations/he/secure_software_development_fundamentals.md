...
ייתכן שידוע מה התוכנה שלך אמורה לעשות (דרישות) וייתכן שיש לך דרך לחלק את הבעיה (תכנון המערכת). אבל אם היישום שלך אינו טוב, התוכנה אינה טובה!
...
**תצוגה מופשטת של תוכנה**

כמעט לכל התוכנות יש קלט (שעליך לאמת), עיבוד נתונים, קריאה לתוכניות אחרות, ובסופו של דבר הפקת פלט(ים). קריאה לתוכנית אחרת יוצרת (למעשה) קלט לאותן תוכניות אחרות, ופלט מאותן תוכניות אחרות. סעיפי המשנה הבאים ידונו בכל אחד מהתחומים הללו בתורו. לאחר מכן נדון בכמה נושאים מיוחדים.

כמובן שזה לא מועיל רק לומר *"לכתוב קוד מאובטח"* או *"לא לעשות טעויות"*. החדשות הטובות הן שכמעט כל השגיאות שגורמות לפגיעויות כיום ניתנות לקיבוץ למספר קטן יחסית של קטגוריות, וחלק מהקטגוריות הללו נפוצות במיוחד. אז כפי שצוין קודם לכן, אנו יכולים לחסל את הרוב המכריע של פגיעויות אבטחה פשוט על ידי למידה על קטגוריות אלה, לדעת איך לחפש אותן, ולצמצם אותן. נזכיר שוב ושוב את רשימת 10 המובילים של OWASP (עבור יישומי אינטרנט) ואת רשימת 25 המובילים של CWE (עבור יישומים באופן כללי), מכיוון שהם מספקים דרך שימושית לזהות מה הכי חשוב.

כמה מהסוגים הנפוצים של פגיעויות הן בעיות תכנון. עם זאת, רוב השאר הן בעיות יישום. כאשר נעבור על מודל התוכנה שלנו, נדון בסוגים הרלוונטיים של פגיעויות, כולל כיצד לזהות אותן ולנטרל אותן. לאחר שתתחילו ליישם מידע זה, תגלו כי פגיעויות רבות נעלמות מהתוכנות שלכם.

כמעט כל התוכנות צריכות לקבל קלט. אז נתחיל לבחון כיצד להטמיע תוכנה מאובטחת על ידי דיון כיצד לטפל באופן מאובטח בקלט.
...
2. הבינו כיצד לאמת מספרים.

3. בידקו בעיות מרכזיות בטקסט, כולל Unicode התאמה אזורית (locale).

4. הסבירו כיצד להשתמש בביטויים רגולריים (regular expressions) כדי לאמת קלט טקסט.

5. הבינו את החשיבות של מזעור משטחי התקיפה.

6. דונו בברירות מחדל מאובטחות ובאתחול מאובטח.

7. שפרו את הזמינות על-ידי התחשבות בקלט.

## יסודות אימות קלט

### מבוא ליסודות אימות קלט

חלק מהקלט מגיע ממשתמשים לא מהימנים, ויש לאמת קלטים אלה (לפחות) לפני השימוש בהם. אם נמנע מנתונים לא חוקיים להיכנס לתוכנה שלנו, יהיה הרבה יותר קשה לתוקפים לנצל אותה. אימות קלט יכול גם למנוע באגים רבים ולהפוך את התוכנה לפשוטה יותר. אחרי הכל, אם התוכנה שלנו יכולה לדחות מיד נתונים פגומים, לא צריך לשכתב את הקוד כדי להתמודד עם מקרים מיוחדים אלה מאוחר יותר. זה חוסך זמן, וסביר יותר שיהיו שגיאות עדינות בקוד כזה המטפל במקרים מיוחדים.

זה יכול להיות גם רעיון טוב לבדוק קלט ממשתמשים מהימנים. אפילו משתמשים מהימנים עושים טעויות, ולתפוס מיד את הטעויות האלה יכול להפוך את המערכת לאמינה יותר. יש ויכוח על כמה אימות צריך להיעשות על קלטים ממשתמשים מהימנים. מצד אחד, משתמשים מהימנים יכולים בבירור לעשות טעויות, ואימות יכול למנוע טעויות יקרות. מצד שני, אם יותר מדי זמן מושקע באימות קלט ממשתמשים מהימנים, יתכן ונדלג על משימות אחרות חשובות יותר, ולפעמים משתמשים מהימנים צריכים להיות מסוגלים לעשות דברים יוצאי דופן כדי להגיב לאירועים בלתי צפויים. כאשר זה לא גוזל זמן רב מדי, כנראה שעדיף לבצע לפחות אימות קלט מסוים גם על קלטים ממשתמשים מהימנים. לצורך קורס זה, נתמקד באימות קלט ממשתמשים לא מהימנים. רק זכרו שניתן ליישם את אותן טכניקות גם על קלטים מהימנים.

תחילה, הקפידו לזהות את כל הקלטים ממשתמשים שעלולים להיות לא מהימנים, כך שנאמת את כולם. כאשר הדבר אפשרי, חסלו את הקלט או הפכו את זה לבלתי אפשרי עבור משתמשים לא מהימנים לספק מידע. דנו בכך קודם לכן בעקרון התכנון *מיזעור משטח התקיפה*.

בכל קלט שנותר ממשתמשים שעלולים להיות לא מהימנים עליך לאמת את הנתונים שמגיעים. בדיקות אימות קלט אלה הן סוג של בדיקת אבטחה, ולכן עליך לוודא שבדיקות אימות קלט אלה אינן ניתנות לעקיפת, כפי שדיברנו קודם לכן בעקרון התכנון *אי-עקיפה*. **כתזכורת:** תנו אמון רק בבדיקות אבטחה (כולל אימות קלט) כאשר הן פועלות בסביבה שניתן לבטוח בה. זה חשוב במיוחד עבור תוכניות JavaScript - מכיון ש JavaScript יכול לרוץ על דפדפני אינטרנט, קל לשלוח בדיקות אבטחה לדפדפן האינטרנט ולשכוח כי *התוקפים* יכולים לשלוט בדפדפני האינטרנט שלהם. לא ניתן לתת אמון בבדיקות אימות קלט שמבוצעות בסביבה לא מהימנה. אם בוטחים בסביבת השרת ולא בסביבת הלקוח, יש לבצע את כל הבדיקות הרלוונטיות לאבטחה בסביבת השרת. דיברנו על זה כבר, אבל חשוב להדגיש כי זו בעיה כל כך נפוצה ורצינית. עכשיו בואו נעבור לאופן שבו ניתן לאמת קלט בפועל.

### כיצד ניתן לאמת קלט?

עליכם לקבוע מה חוקי, באופן צר ככל שתוכלו באופן סביר, ולדחות כל דבר שאינו תואם את ההגדרה הזו. שימוש בכללים המגדירים מה חוקי, ובמשתמע דחיית כל דבר אחר, נקרא  *אלאו-ליסטינגס (רישום היתרים, allowlisting)* (הכללים עצמם הם *אלאו-ליסט (רשימת היתרים, allowlist)*). מילים נרדפות הן *גוד-ליסטינג (רישום חיוביים, goodlisting)* (הכללים הם *גוד-ליסט (רשימת חיוביים, goodlist)*) וה*ווייט-ליסטינג (רישום לבן, whitelisting)* הנפוץ מבחינה היסטורית (הכללים הם *ווייט-ליסט (רשימה לבנה, whitelist)*). באופן כללי, אל תעשו את ההפך. כלומר, זו בדרך כלל טעות לנסות לזהות מה לא חוקי ולכתוב קוד כדי לדחות רק את המקרים האלה. גישה זו, שאינה בטוחה בדרך כלל, שבה מנסים לרשום את כל מה שצריך לדחות, נקראת *דיניי-ליסטינג (רישום איסורים, denylisting)* (הכללים הם *דיניי-ליסט (רשימת איסורים, denylist)*). מילים נרדפות לדיניי-ליסטינג הן *באד-ליסטינג (רישום שגויים, badlisting) ובלאק-ליסטינג (רישום שחור, blacklisting)* הנפוצה מבחינה היסטורית (הכללים נקראים באד-ליסט (רשימת שגויים, badlist) ובלאק-ליסט (רשימה שחורה, blacklist)). דיניי-ליסטינג (רישום איסורים, denylisting) מובילה בדרך כלל לפגיעויות אבטחה, מכיוון שאם שוכחים לטפל במקרה חשוב אחד או יותר של קלט לא חוקי, זו יכולה להיות הזדמנות עבור תוקף. לעומת זאת אם נשכח לאפשר מקרה, נקבל דוח באגים והתוכנה שלנו תיכשל באופן מאובטח. חוץ מזה, זה בדרך כלל הרבה יותר קל ופשוט לזהות *מה מותר* ולאפשר רק את הקלט הזה. בכמה מקרים נדירים *בהחלט ניתן* להיות בטוחים שזיהינו את כל הקלט הרע האפשרי, ובמקרה זה דיניי-ליסטינג הוא בסדר, אבל אלה נדירות. בדרך כלל דיניי-ליסטינג מוביל לצרות.

 אימות קלט לא תקין הוא גורם כה נפוץ לפגיעויות אבטחה שהוא #3 2019 ב CWE Top 25 ו #4 ב 2021 CWE Top 25. הוא מזוהה גם כ- [CWE-20](https://cwe.mitre.org/data/definitions/20.html) (*אימות קלט לא תקין*).
...
ישנה סיבה טובה לזהות ערכים *בלתי חוקיים*; השתמשו בהם בסדרה של בדיקות כדי לוודא שקוד האימות יסודי. ייתכן שבדיקות האלה פשוט מבוצעות בראש שלך, אבל לפחות כמה מהן אמורות להפוך לטסט-קייס (test cases) בחבילת הבדיקות האוטומטית שלך. כאשר אנו בונים מסנן קלט, אנו תוקפים מנטלית את האלאו-ליסט (רשימת ההיתרים, allowlist) שלנו עם כמה ערכים לא חוקיים שזוהו מראש כדי לוודא שכמה ערכים לא חוקיים ברורים לא יעברו. בהתאם לקלט, הנה כמה דוגמאות לערכים לא חוקיים נפוצים שמסנני הקלט שלך עשויים להזדקק למנוע: המחרוזת הריקה, "**.**", "**..**", ".**../**", כל דבר שמתחיל ב-"**/**" או "**.** ", כל דבר עם "**/**" או "**&**" בתוכו, מטא-תווים נפוצים (כמו נקודה-פסיק, מרכאות בודדות, מרכאות כפולות והסימן הפחות מ-), וכל תווי הבקרה (במיוחד תו NUL והשורה החדשה). כאשר צפויים מספרים, בדיקה אם קיימים סוגים אחרים של טקסט שאין להתיר אותם. בדקו גם קלט מאוד מאוד ארוך.

בהמשך, נדון בסוגים שונים של כלי ניתוח אבטחה. סוג אחד, fuzzers, בכוונה יוצר מספר רב של קלט זדוני אשר (בין היתר) בודק את איכות בדיקות אימות הקלט שלך. אבל fuzzers אינם מבטיחים למצוא את כל בעיות אימות הקלט. במקום זאת, יישמו בזהירות את אימות הקלט ולאחר מכן השתמש בכלים שיעזרו לכם למצוא בעיות שאחרת הייתם מפספס.

שוב, הקוד שלך צריך להשתמש ב -*אלאו-ליסט (רשימת ההיתרים, allowlist)* (זיהוי צר של מה חוקי ודחיית השאר), ולא ב - *דיניי-ליסטינג (רישום איסורים, denylisting)* (מנסה לזהות קלטים שגויים). נסו להפוך את תבנית הרשימה המותרת לצרה ככל האפשר, כולל הגבלת אורך הקלט המרבי (ואורך הקלט המינימלי במידת הצורך).
...
באופן כללי, צריך להשתמש ב -*אלאו-ליסט (רשימת ההיתרים, allowlist)*, ולא ב - *דיניי-ליסטינג (רישום איסורים, denylisting)*. תוקפים תמיד יכולים להמציא התקפה נוספת, ולכן הניסיון להמציא רשימה של "כל מה שצריך להכחיש" היא משימה בלתי נגמרת. בדרך כלל עדיף לקבוע באופן צר מה צריך להיות מותר, ולאחר מכן לדחות את כל השאר.
...
אם כך, כיצד ניתן לבצע אימות קלט המשתמש באלאו-ליסט (allowlist) (כלומר, תבנית המוגדרת באופן צר ככל האפשר)? בקצרה, מבצעים זאת על כל קלט, ומה שבודקים תלוי בסוג הנתונים. בואו נדון בכמה מקרים נפוצים.

#### מספרים

קלט נפוץ אחד הוא רצף של תווים המייצגים מספר. בדרך כלל, בודקים מספרים (במיוחד מספרים שלמים) כדי לוודא שהם בין ערך מינימלי לערך מקסימלי. כדאי לעשות בדיקה לפני שממירים את הטקסט למספר, אבל במקרה מסוים זה, בידקו את הערך *לאחר* ההמרה למספר, כדי להיות בטוחים כי *שאר* התוכנה תראה את המספר רק אם הוא בטווח חוקי. המינימום הנפוץ הוא 0 ו-1. אם המספר אמור להיות מספר שלם, ודאו שהוא מספר שלם ודחו כל דבר אחר.

כאשר הדבר מעשי, אחסנו את התוצאה המספרית בטיפוס (type) המוגדר באופן צר למטרה. לדוגמה, אחסנו את המספר בטיפוס מספר שלם אם המספר הוא מספר שלם, השתמשו בטיפוס אן-סיינד (unsigned) אם מספרים שליליים אינם מותרים, וכן הלאה. אם צריך לקבל נתוני נקודה צפה (floating point) ממשתמש לא מהימן (וכדאי לנסות שלא!), אחסנו אותם בטיפוס מתאים והיזהרו מהמקרים המיוחדים הרבים שלהם (כגון NaN, אינסוף, 0 שלילי, והצפות (underflows and overflows)). לדוגמה, בדרך כלל ערך הנקודה הצפה NaN אינו שווה לערך כלשהו; היא אפילו לא שווה לעצמה. הגבלת הטיפוס אינה תמיד מעשית משום שהיא מאוד תלויה בשפה; לא לכל השפות יש טיפוסים כאלה. לדוגמה, JavaScript אינו כולל טיפוס אן-סיינד (unsigned).

שימו לב ש *"אפשר רק מספר שלם בין 0 ל- 200 כולל נקודות קצה אלה"* היא אלאו-ליסט (allowlist); זיהיתם את התבנית של מה שמותר, וכל דבר אחר יידחה.

#### תבניות טקסט מיוחדות ידועות

לפעמים הקלט שלך הוא טקסט עם פורמט סטנדרטי ויש ספריה שיכולה לבצע את האימות עבורך. לדוגמה, לרוב השפות יש יכולת כלשהי לבדוק את הפורמט של כתובות דואר אלקטרוני. כשיש לנו מימוש אחד שניתן לסמוך עליו, נשתמש בו!

לעתים ספריות האימות שבהן באפשרותך להשתמש דורשות תצורה מסוימת. שוב, הגדירו אותם להיות צרים (מגבילים) ככל האפשר. לדוגמה, אם מקבלים HTML, הגבילו אותו רק לתגים ולתכונות הדרושים. לעתים קרובות, כאשר מקבלים HTML, עלינו לקבל רק כמה תגים (לדוגמה,  **&lt;i>** עבור *נטוי*, **&lt;b>** עבור **מודגש**, **&lt;a>** עבור לינקים, היפר-קישורים) ותכונות (לדוגמה, התכונה **href** של התג **&lt;a>** כך שאפשר יהיה לומר לאן לקשר, ואולי תכונת **id** כך שאחרים יוכלו להתייחס לנקודה מסוימת). לאחר מכן, כאשר תוקף ינסה לספק HTML עם תגים אחרים (לדוגמה, **&lt;script>** זדוני), המאמת פשוט לא יקבל אותו כלל.

תבניות קלט מסוימות הן מבנים מורכבים של הרבה נתונים אחרים. לדוגמה, קבצי JSON, XML ו- CSV יכולים להכיל נתונים רבים אחרים. בדרך כלל נשתמש בספריה אמינה כדי לבחון ולחלץ את חלקי הנתונים הדרושים, ולאחר מכן נאמת כל פריט. שוב, אם מחלצים רצף של תווים המייצגים מספר, נאמת את המספר (למשל, כדי לראות אם הוא נמצא בטווח המינימלי והמקסימלי). במקרים רבים, זהו ערך טקסט. בהמשך נדון בטיפול במבנים מרוכבים, אך בשלב מסוים הם יתפרקו לערכים ספציפיים, לעתים קרובות כמספרים או כטקסט.

תוכנות רבות צריכות לאמת שדות טקסט, כאשר הכללים של שדות אלה אינם מוגדרים בספריה קיימת. חלק מהכלים מאפשרים לנו להתמודד איתם בקלות, אבל כדי להשתמש בהם, אנחנו צריכים להבין קצת רקע. תחילה נצטרך לדון יותר על טקסט, unicode והתאמה אזורית (locale) באופן כללי. לאחר מכן נדון באימות טקסט באופן כללי ובדרך המקובלת לעשות זאת - ביטויים רגולריים.

#### חידון 1.2: אימות קלט: כמה סוגי נתונים פשוטים

\>\>בחרו את כל שיטות העבודה המומלצות לאימות מספר קלט ממקור לא מהימן:<<

[!x] בדיקה כי הוא לפחות גדול כמו המינימום.

[x] בדיקה שהוא לכל היותר גדול כמו המקסימום.

[x] שימוש בטיפוס אן-סיינד (unsigned) אם השפה שלך תומכת בו והקלט אינו מורשה להיות שלילי.

[x] דרישה שהמספר יהיה מספר שלם אם זהו סוג המספר הצפוי היחיד.

### סיפור צדדי: טקסט, Unicode והתאמה אזורית (locale)

[[אופציונלי]]

לעתים קרובות מתקבל טקסט כקלט (ישירות או כחלק ממבנה גדול יותר). נתאר טקסט פשוט כרצף של תווים. אם קלט הטקסט אינו מהימן, עליך לאמת טקסט זה. כדי להבין את נקודה זאת, עלינו להבין *מהו* טקסט. מספר גדול להפליא של מפתחים ומפתחות מעולם לא למדו על טקסט - למרות שזה אחד מסוגי הנתונים הנפוצים ביותר - אז בואו נוודא את ההבנה קודם. אם אתם בטוחים שאתם כבר מכירים בעיות טקסט כגון יוניקוד (Unicode), קידוד (אנקודינג, encoding) והתאמה אזורית (locale), אל תהססו לדלג הלאה.

#### נקודות קוד (קוד-פוינט, Code Points) וקידוד (אנקודינג, encoding)

מחשבים דיגיטליים אינם מטפלים ישירות בתווים; במקום זאת עלינו להקצות מספר לכל תו. ערכות תווים שונות עם משימות שונות נוצרו עבור שפות שונות, דבר אשר גורם לקשיים ביכולת שלהם לפעול בצורה הדדית. ברוב המכריע של המקרים כיום נשתמש בהקצאות התווים שצוינו על-ידי Unicode ו- ISO/IEC 10646, המגדירות ערכת תווים אוניברסלית (UCS) המקצה מספר ייחודי (*נקודת קוד (קוד-פוינט, Code Points)*) עבור כל תו. לדוגמה, הם מקצים לתו הלטיני "A" את המספר העשרוני 65.

מבחינה היסטורית, פעם חשבו ש-16 סיביות יספיקו כדי לזהות את כל התווים, אבל זה היה שגוי ושונה ב-1996 (כיום משתמשים ב-21 סיביות כדי לקודד כל תו). כתוצאה מטעות זו, לחלק משפות התכנות יש סוג "תו" (למשל, **תו (char)** של ג'אווה) שאורכו 16 סיביות בלבד. סוג נתונים של 16 סיביות אינו יכול, כשלעצמו, לאחסן כל תו (char) שרירותי של 21 סיביות, כך שבשפות תכנות וממשקי API עם "תו" של 16 סיביות, "תו" הוא לפעמים רק חצי תו בפועל.

יש להחליף טקסט המשתמש במשימות אלה באמצעות *קידוד (אנקודינג, encoding)*. ישנם חמישה קידודים סטנדרטיים עבור יוניקוד (Unicode): UTF-32 (ביג-אנדיאן וליטל-אנדיאן (big-endian and little-endian)), UTF-16 (ביג-אנדיאן וליטל-אנדיאן) ו-UTF-8. באופן כללי, עליך להשתמש ב- UTF-8 אלא אם כן יש לך סיבה לעשות אחרת. ל-UTF-16 ול-UTF-32 יש שתי צורות: "ליטל-אנדיאן" (little-endian) ו"ביג-אנדיאן" (big-endian). אם לא ידוע אם הנמען מצפה ל-ביג-אנדיאן או לליטל-אנדיאן, יש להוסיף *סמן סדר בייטים (byte order marker)* בתחילת הטקסט כדי לוודא שהמקבל מפרש אותו כראוי, ובעת קבלת UTF-16 או UTF-32, היישום שלך צריך לשים לב לכך. בעיה קריטית היא שרצפים מסוימים של בייטים *אינם* חוקיים, ולכן כאשר אנו מבצעים אימות קלט, נצטרך לוודא שהנתונים שאנו מקבלים תקפים לקידוד שאנו מצפים לו.

#### התאמה אזורית (Locales)

פירוש  התווים מסובך יותר ממה שאתם חושבים. הרבה תלוי ב"אזור", המגדיר את שפת המשתמש, מדינה/אזור, העדפות ממשק משתמש וכנראה גם קידוד תווים. לדוגמה, במערכות יוניקס/לינוקס, אנגלית אוסטרלית עם קידוד UTF-8 מיוצגת כאזור **en_AU. UTF-8**. התאמה אזורית חשובה, מכיוון שהיא משפיעה על האופן שבו התווים מתפרשים. לדוגמה, זה משפיע על:

* סידור ומיון

* סיווג תווים (מהי "אות"?). טווחים כמו "A-Za-z" אינם מפרטים *את כל התווים האלפביתיים* באזורים שרירותיים. אם משתמשים בהתאמה אזורית של שפת C או POSIX ומעבדים רק תווי ASCII, אז טווח זה הוא הרשימה המלאה של תווים אלפביתיים, אך הדבר אינו נכון באופן כללי.

* המרת רישיות (מהן אותיות גדולות/קטנות של תו, אם הן קיימות?). שימו לב שגם אם יש המרה, ייתכן שהיא לא תומר לתו בודד באזור נתון.

אם ברצונך לפרש טקסט באותו אופן ללא קשר לאזור, הפתרון הרגיל הוא להשתמש באזור "C" הידוע גם כ "POSIX" - עם זאת, יש להיזהר, כי זה לא תמיד מה שהמשתמשת רצתה.

המרה בין אותיות גדולות לקטנות היא בעייתית במיוחד. בשפות מסוימות אין אותיות גדולות וקטנות. גם אם כן, המיפוי ביניהם שונה בין אזורים שונים. אז הגרסה באותיות רישיות של אות *אינה* קבועה - היא מבוססת על האזור!

דוגמה מצוינת לכך הן השפות הטורקיות המשתמשות באלפבית הטורקי. באלפבית זה אותיות "I" מנוקדות וחסרות נקודות הן אותיות נפרדות עם צורות אותיות גדולות וקטנות. לדוגמה, אותיות קטנות מנוקדות "i" כאשר הן רישיות הופכות לאותיות רישיות מנוקדות "İ" (לא אותיות רישיות ללא נקודה "I" כפי שקורה באזור אנגלי), ואותיות רישיות ללא נקודה "I" כאשר אותיות קטנות הופכות לאותיות קטנות ללא נקודה "ı". שימו לב כי "i" ו- "I" *אינן* שוות בהתאמה ללא רגישות לרישיות במערכת המיושמת כראוי עבור אזורים כאלה. זה הביא למספר נקודות תורפה באבטחה, ומדי פעם נזכיר זאת בקורס מכיוון שזו דוגמה מצוינת לסוגי הטעויות שיכולות לקרות אם לא קיימת מודעות לכך.

אם רוצים לדעת אם "שני רצפים של תווים שקולים" תוך התעלמות מאותיות גדולות וקטנות, אז במקרה הכללי צריך לקרוא לפונקציונליות שיודעת לעשות את זה *ולספק* לה את ההתאמה האזורית שבשימוש. זה מעלה את הסוגיה על שקילות (אקויולנטיות) באופן כללי, אשר בה נדון בהמשך.

#### שקילות (אקויולנטיות) יוניקוד (Unicode)

מתכנתים ומתכנתות רבים מניחים שאם רצף של "נקודות קוד" בטקסט שונים, אזי הן מחרוזות שונות. אמנם זו בדיקה שהיא בסדר למטרות מסוימות, אבל זה המודל המנטלי הלא נכון עבור מטרות אחרות, גם אם מניחים שרוצים התאמה "תלוית אותיות גדולות וקטנות". יוניקוד (Unicode) היה צריך להיות מפותח באופן שתואם את התקנים הקיימים, ודבר זה הוביל לכמה סיבוכים.

במקרים מסוימים עליך להשתמש בפונקציונליות מספרייה כדי לבדוק שקילות קנונית של יוניקוד (Unicode). הסיבה לכך היא שיש כמה נקודות קוד, או רצפים של נקודות קוד, אשר בנסיבות רבות צריך להיחשב *שווה ערך* במובן זה שהם צריכים תמיד להיראות זהים, גם אם יש להם ערכים בסיסיים שונים. לדוגמה, נקודת הקוד U+006E (האותיות הקטנות הלטיניות "n") ואחריה U+0303 (הטילדה המשלבת "◌̃") שקולה מבחינה קנונית לנקודת הקוד U+00F1 ("ñ").  דוגמה נוספת היא התו "Å" שניתן לייצג כ- U+00C5 (האות "אות גדולה לטינית A עם טבעת מעל") או כ- U+212B ("סימן אנגסטרום"): שני ערכים אלה צריכים להיחשב שקולים.

במקרים אחרים, עליך להשתמש בפונקציות כדי לבדוק תאימות ליוניקוד (Unicode). הסיבה לכך היא שישנם כמה רצפים שעשויים להיראות שונים אך תהיה להם אותה משמעות בסיסית. לדוגמה, נקודת הקוד U+FB00 (טיפוגרפית "ff") תואמת, אך לא שוות ערך, ל- U+0066 U+0066 (שתי אותיות "f" לטיניות). מחרוזות שוות ערך תואמות תמיד, אך מחרוזות תואמות אינן תמיד שוות ערך.

זוהי נקודה כואבת, ולכן תקן יוניקוד (Unicode) מגדיר הליכי נורמליזציה של טקסט, הנקראים נורמליזציה של יוניקוד. נורמליזציה של יוניקוד הופכת רצפים מקבילים או תואמים לאותו רצף תווים בדיוק. ישנן 4 צורות נורמליזציה:

* NFD (נורמליזציה של צורת פירוק קנוני, Normalization Form Canonical Decomposition)<br>תווים מפורקים על ידי שקילות קנונית, ותווים משולבים מרובים מסודרים בסדר מסוים.

* NFC (נורמליזציה של צורת הרכב קנוני, Normalization Form Canonical Composition)<br>תווים מפורקים ולאחר מכן מורכבים מחדש על ידי שקילות קנונית.

* NFKD (נורמליזציה של צורת תאימות פירוק, Normalization Form Compatibility Decomposition)<br>תווים מפורקים על-ידי תאימות, ותווים משולבים מרובים מסודרים בסדר מסוים.

* NFKC (נורמליזציה של צורת תאימות הרכב, Normalization Form Compatibility Composition)<br>תווים מפורקים על ידי תאימות, ולאחר מכן מורכבים מחדש על ידי שקילות קנונית.

מנקודת מבט של אבטחה, בדרך כלל אין זה משנה *באיזו* נורמליזציה של יוניקוד משתמשים, אך אם ברצוננו לקבוע אם שתי מחרוזות שוות, עלינו להיות *עקביים* לגבי הנורמליזציה שבה משתמשים בעת השוואתן. כמו כן, שימו לב שברגע שמנרמלים רצף של תווים, לא ניתן באופן כללי ליצור מחדש בדיוק את הרצף המקורי.

#### התחזות חזותית (Visual Spoofing)

*התחזות חזותית* מתרחשת כאשר המשתמש טועה לחשוב כי שתי מחרוזות שונות הן *זהות*. תוקפים ישתמשו לעיתים בהתחזות חזותית כחלק מהתקפה.

התחזות חזותית יכולה להתרחש אפילו בקבוצת המשנה ASCII של יוניקוד (Unicode). הספרה "0" נראית כמו האות הגדולה "O", והספרה "1" נראית כמו האות הקטנה "l". לדוגמה, תוקף עשוי לנסות ליצור דומיין **paypa1.com** זדוני במקום **paypal.com**. הרצף "rn" נקרא לעתים בטעות כאות "m"! עם זאת, רוב המשתמשים באלפבית לטיני מודעים לבעיות אלה, וגופנים רבים דואגים להפוך אותם למובחנים יותר.

אבל ברגע שאנחנו מתקדמים מעבר לתת-קבוצה ASCII, קיימים טריקים רבים אחרים:

* פירוק, דה-קומפוזישן (Decomposition)<br>"ƶ" עשוי להתבטא כ- U+007A U+0335 (z + שילוב של שכבת-על של קו קצר) או כ- U+01B6. משמעות הדבר היא כי רצפים שונים של בתים עשויים עדיין להצביע על אותה אות (ולכן להיראות זהים). נורמליזציה פותרת בעיה זו.

* ב מעורב (Mixed-script)<br> "o" באומיקרון יווני ובלטינית נראים בדרך כלל אותו דבר, למרות שהם נמצאים בחלקים שונים של יוניקוד.

* אותו סקריפט (Same-script)<br>חלק מהדמויות פשוט נראות דומות. לדוגמה, "-" מקף-מינוס U+002D לעומת מקף "‐" U+2010.

* זיוף טקסט דו-כיווני (Bidirectional Text Spoofing)<br> חלק מהשפות הן ברובן מימין לשמאל, אך עוברות במצבים מסוימים להיות משמאל לימין. לפיכך, יוניקוד (Unicode) כולל מנגנונים לציון כיוון. אבל זה אומר כי המחרוזת "olleh", מוקפת בתיוג "להשתמש מימין לשמאל", תיראה חזותית זהה ל "hello".

התחזות חזותית יכולה להיות מאתגרת מאוד להתמודדות באופן כללי. נורמליזציה ושימוש בגופנים ייחודיים לא תמיד תספיק, אבל זה יכול לפעמים להיות מאוד מועיל.

#### חידון 1.3: סיפור צדדי: טקסט, Unicode והתאמה אזורית (locale)

\>\>ביוניקוד- (Unicode) תו מיוצג על-ידי ערך של 16 סיביות. אמת או שקר?<<
...
יש יותר מדי תווים מכדי לקודד את כולם ב- 16 סיביות, כך שיוניקוד משתמש כעת ב- 21 סיביות כדי לקודד תווים. שפות וממשקי API רבים משתמשים בערכי "תו" של 16 סיביות, אך אם עליהם לייצג את כל תווי היוניקוד, לעתים תווים בהם יהיו רק *חלק* מתוו ממשי.

[הסבר]

### אימות טקסט

עכשיו שיש לנו הבנה לגבי טקסט, בואו נדבר על אימות שלו. כמעט בכל המקרים יש לפחות שתי בדיקות שיש לעשות על טקסט ממקור לא מהימן:

* ודאו שהטקסט נמצא בקידוד הטקסט הצפוי. כפי שצוין קודם לכן, אלא אם כן יש סיבה לעשות אחרת, אנו ממליצים להשתמש בקידוד UTF-8. UTF-8 יאפשר לעבוד עם סקריפטים משפות שרירותיות, הוא תואם לאחור עם ASCII, והוא נתמך באופן נרחב. UTF-8 הוא קידוד טוב, אך לא כל רצף של בתים הוא UTF-8 חוקי. פגיעויות רבות התרחשו מכיוון שמערכת קיבלה בתים מתוקף שאינם חוקיים UTF-8. לכן חשוב מאוד לאמת טקסט UTF-8 לפני שמקבלים אותו ממקור לא מהימן.

* בידקו אם הוא נמצא באורך המינימלי והמקסימלי, אם יש אורכים מינימליים ומקסימליים. מערכות רבות ירצו שיהיה להן מקסימום פשוט כדי למנוע מהתוקפים לשלוח כמויות גדולות באופן אבסורדי של נתונים.

במקרים מסוימים זה עשוי להיות קשה מאוד לבדוק הרבה יותר מכך. שמות אישיים, בפרט, הם מאתגרים, במיוחד אם חייבים להתמודד עם שמות בכל האזורים הגאוגרפיים. באזורים רבים יש מוסכמות שונות ממקומות אחרים; לדוגמה, האם השם הפרטי או שם המשפחה (למשל, שם המשפחה) מופיעים ראשונים? אולי אפילו אין שם משפחה או שם פרטי. שמות עשויים להכיל רווחים (אפילו בתוך שם פרטי או שם משפחה), וכמובן, אין ערובה לכך שהשם משתמש רק בתווים לטיניים או סיניים. לדיון באתגרים, ראו את [*השקרים שמתכנתים מאמינים בהם לגבי שמות – עם מאמר דוגמאות*](https://shinesolutions.com/2018/01/08/falsehoods-programmers-believe-about-names-with-examples/) מאת טוני רוג'רס (2018).
...
לפעמים ערך הטקסט חייב להיות אחד מרשימה קצרה של ערכים. זה קל, פשוט לאחסן את האוסף המותר איפשהו (למשל, בסט או במילון). לאחר מכן, בכל פעם שמתקבל קלט, נודא שהקלט הוא אחד מהערכים המותרים.

אבל זה משאיר אותנו עם קלטי טקסט רבים שיש להם כללים, אבל הם לא רק רשימה של ערכים מותרים. הם עשויים להיות תאריכים, שעות, מספרי חלקים, מספרי טלפון, מיקומים ושלל סוגים אחרים של נתונים. אנחנו עדיין צריכים לאמת את הקלט הזה, ולתוכניות רבות יש סוגים רבים ושונים של נתונים. זה אומר שאנחנו צריכים איזושהי דרך לתאר *בקלות* את כללי האימות האלה. הכלי הנפוץ למטרה זו הוא ביטויים רגולריים. ביחידה הבאה, נסביר באופן אופציונלי ביטויים רגולריים (regexes) אם אינכם מכירים אותם; היחידה שאחריה תסביר כיצד להשתמש בביטויים רגולריים כדי לאמת קלטים.

### מבוא לביטויים רגולריים

[[אופציונלי]]

אם אתם כבר יודעים על ביטויים רגולריים, אל תהססו לדלג על יחידה זו.

ביטוי רגולרי (רגאקס, *regex*) הוא רצף תווים המגדיר תבנית טקסט. כמעט לכל שפות התכנות יש מערכת מובנית או ספרייה שניתנת לשימוש בקלות המיישמת שפת ביטוי רגולרי, ולכן בדרך כלל קל להתחיל להשתמש בביטויים רגולריים בתוכנה ללא קשר לאופן שבו היא מיושמת.

עם זאת, ישנם מפתחי ומפתחות תוכנה שמעולם לא השתמשו בביטויים רגולרי. יחידה זו מספקת מבוא קצר אם הם עדיין לא מוכרים לך. אם רגאקס (regexes) כן מובנים לך , ניתן לדלג ליחידה הבאה!

מבחינה היסטורית ביטויים רגולריים פותחו כדי להקל על חיפוש טקסט, אם כי כיום הם משמשים לעתים קרובות כדי לקבוע אם טקסט מסוים מתאים לתבנית. ישנם יישומים רבים של מערכות רגאקס (regex), אבל מכיוון שהם כולם באים מאותו מקור היסטורי יש להם הרבה במשותף.

הכלל הטריוויאלי ביותר הוא שאות או ספרה תואמת את עצמה. כלומר הרגאקס, (regex) **"d"** תואם את האות "**d**". רוב היישומים משתמשים בהתאמות תלויות רישיות כברירת מחדל, וזה בדרך כלל מה שרוצים.

כלל נוסף הוא שסוגריים מרובעים מקיפים כלל המציין כל אחד ממספר התווים. אם הסוגריים המרובעים מקיפים רק תווים אלפאנומריים, התבנית מתאימה לכל אחד מהם. אז **[brt]** מתאים למופע יחיד של "**b**", "**r**", או "**t**".

התבנית "**.**" מתאימה לכל תו אחד, למעט התו לשורה-חדשה (newline). אם ברצונך להתאים לתו נקודה באופן מילולי, קדם לה קו נטוי הפוך ("**\.** "). כמעט לכל יישום של רגאקס (regexes) יש מנגנון כדי לאפשר לך להחליט אם "**.** " צריך להתאים לתו לשורה חדשה (newline).

תבנית רגאקס (regex) היא בדרך כלל רצף של כללים, כאמור אחד אחרי השני. לדוגמה, תבנית רגאקס (regex) "**ca[brt]**" תתאים לטקסט "**cab**", "**car**", או "**cat**", מכיוון שהאותיות "**c**" ו- "**a**" תואמות את עצמן, ו- "**[brt]**" מתאים למופע יחיד של-**"b**", "**r**" או "**t**".

למעשה, כברירת מחדל רגאקס, (regexes) *מחפשים* את התבנית הנתונה במחרוזת. כלומר, בדרך כלל יישום רגאקס (regex) יראה אם תבנית תואמת טקסט כלשהו אם היא מתחילה בתו הראשון, ואז בתו השני, וכן הלאה, ותדווח אם היא יכולה למצוא התאמה *כלשהי*. אז התבנית "**ca[brt]**" תתאים גם ל-"**abdicate**" כי יש "**cat**" במילה "**abdicate**".

עם זאת, ביטויים רגולריים יכולים לעשות הרבה יותר. אם עוקבים אחר תבנית עם "**&#42;**", כלומר "*0 פעמים או יותר*". אז תבנית רגאקס (regex) **"a&#42;b&#42;**x" מתארת תבנית של 0 או יותר **a**, ואחריה 0 או יותר **b**, ואחריה **x**. תבנית זו תואמת מחרוזות כמו "**aabx**", "**bbbx**" ו-"**abx**", אך לא "**aabb**". רוב יישומי הרגאקס (regex) תומכים גם ב- "**+**" עבור "*פעם אחת או יותר*" ו- "**?** " עבור "*0 או פעם אחת*". רוב יישומי הרגאקס (regex) מאפשרים לך גם להשתמש בסוגריים כדי לקבץ ביטויים, לדוגמה, "**f(abc)&#42;**d" תואם אם יש "**f**", ואחריו 0 או יותר מופעים של הרצף "**abc**", ואחריו האות "**d**".

בדרך כלל ניתן לבצע התאמה חסרת רגישות לרישיות באמצעות אפשרות כלשהי. הקפידו להגדיר את האזור אם משתמשים בהתאמה חסרת רגישות לרישיות, מכיוון שלשפות שונות יש כללים שונים, ולפעמים הכללים יכולים להיות מורכבים. לדוגמה, בגרמנית, האות "sharp-s" באותיות קטנות "**ß**" שקולה לאותיות רישיות "**SS**" בעת שימוש בהתאמה חסרת רגישות לרישיות. במקרים מסוימים, ייתכן שנירצה לבצע רק "*התאמה חסרת רגישות לרישיות ASCII*"; פעולה זו משווה רצף של נקודות קוד כאילו כל נקודות קוד ASCII בטווח 0x41 ל- 0x5A (A עד Z) מופו לנקודות הקוד המתאימות בטווח 0x61 ל- 0x7A (a עד z).

יש הרבה יותר אפשרויות רגאקסים. למעשה, יש ספר שלם על ביטויים רגולריים בלבד, [*שליטה בביטויים רגולריים, מהדורה שלישית,*](https://www.oreilly.com/library/view/mastering-regular-expressions/0596528124/) מאת ג'פרי פרידל (2006), ויש הרבה מדריכים על רגאקסים כגון [המדריך לביטויים רגולריים לאנשים רגילים](https://refrf.shreyasminocha.me/) מאת שריאס מינוצ'ה. אבל הקדמה זו תביא אותנו לנקודת התחלה, כי אנחנו עכשיו הולכים לדון כיצד רגאקס (regexes) יכול לשמש לאימות קלט.

### שימוש בביטויים רגולריים לאימות קלט טקסט

תוכנות רבות צריכות לאמת במהירות טקסט קלט ממקורות לא מהימנים. אמנם ישנן דרכים רבות לעשות זאת, אך רגאקס (regexes) הם לעתים קרובות כלי שימושי במיוחד לאימות קלט של טקסט. ביטויים רגולריים, רגאקס (Regexes) הם בדרך כלל מהירים לרישום (כך שהם לוקחים מעט מאוד זמן פיתוח), קלים לשימוש וזמינים באופן נרחב. הם גם גמישים מספיק עבור משימות אימות קלט רבות, קומפקטיים, ובדרך כלל מתבצעים במהירות רבה. הם גם ידועים ומובנים באופן נרחב. אלה יתרונות חשובים; אם כתיבת אימות קלט קשה מדי, זה לא ייעשה. הם לא פותרים את כל בעיות אימות הקלט האפשריות, אבל הם שימושיים מספיק כדי שיהיה חשוב לדעת אותם.

ביטויים רגולריים שימשו במקור בתוכנה *לחיפוש* תבניות טקסט, ולא לאימות קלטי טקסט כנגד תבנית. ביטויים רגולריים, רגאקס (Regexes) טובים גם באימות קלט טקסט, אך יש כמה דברים שעליך לדעת כדי שיהיה אפשרי להשתמש בהם כראוי לאימות קלט טקסט.

#### התאימו, אל תחפשו

בעיה מרכזית עם יטויים רגולריים, רגאקס (Regexes) היא כי כברירת מחדל רוב יישומי הרגאקס (regex) *מחפשים* כדי לראות אם ניתן למצוא  תבנית נתונה בכל מקום בתוך טקסט כלשהו. כשאנחנו עושים אימות קלט אנחנו לא רוצים לחפש; אנו רוצים לדעת אם כל קלט הטקסט *תואם בדיוק* לתבנית. זה אומר שאנחנו צריכים להיות מסוגלים לשאול את יישום הרגאקס (regex) "*האם קלט טקסט זה תואם בדיוק את התבנית הזו"* - ולדחות את הקלט אם הוא לא תואם. כמו בכל אימות קלט אחר, עלינו להפוך את התבנית שלנו למגבילה ככל האפשר, ואם הקלט אינו תואם, אז לדחות את הקלט.

הדרך הרגילה לדרוש מרגאקס (regex) להתאים קלט שלם היא לכלול *עוגנים (anchors)* ברגאקס (regex). פשוט התחילו את תבנית הרגאקס (regex) שלכם עם *עוגן התחלה* - המיוצג בדרך כלל על ידי "**^**" או לפעמים “**\A**” - וסיימו את התבנית עם “**$**” או לפעמים “**\z**”. עם אלה, הקלט כולו חייב להתאים לתבנית. לדוגמה, הרגאקס (regex) הבא יתאים *לכל* טקסט המכיל "**cab**", "**car**", או **"cat**" -הוא אפילו יתאים ל "**abdicate**" - לכן לא צריך להשתמש ברגאקס (regex) כזה לאימות קלט:

**ca[brt]**

לעומת זאת, הרגאקס (regex) הבא יתאים *רק* למילים "**cab**", "**car**", או "**cat**" ברוב יישומי הרגאקס (regex), מכיוון ש “**^**” פירושו *"התאם את ההתחלה"* ו-“**$**” פירושו *"התאם את הסוף"*:

**^ca[brt]$**

ביישומים מסוימים (בהתאם לאפשרות), “**^**” עשוי להיות *"התחלה של כל שורה"* ולא *"תחילת המחרוזת"*  - ובדרך כלל נרצה את *"תחילת המחרוזת"*. דבר דומה יכול לקרות עם "**$**". מכאן והלאה נניח כי "**^**" ו- "**$**" פירושם התחלה וסוף של המחרוזת כולה.

#### דעו את יישום Regex שלכם

כמעט לכל שפת תכנות יש לפחות יישום רגאקס (regex) טוב אחד. כולם חולקים תכונות רבות, אך רבים מהם שונים במקצת. לכן, כאשר משתמשים ביישום רגאקס (regex) שלא בוצע בו שימוש בעבר, יש לעיין בתיעוד שלו בכל פעם שיש שימוש בפעולה שלא השתמשת בה בעבר. הנה כמה וריאציות שכדאי לחפש.

ישנן שלוש משפחות עיקריות של סימונים בשפת רגאקס (regex):

1. ביטוי רגולרי בסיסי (Basic regular expression - BRE)<br>זוהי ברירת המחדל עבור **grep** ו - **sed**. מוגדר על ידי תקן POSIX. עם זאת, התחביר שלו לפעמים קצת מוזר, ולכן ברוב המקרים, קל יותר להשתמש בביטויים רגולריים מורחבים במקום זאת לאימות קלט.

2. ביטוי רגולרי מורחב (Extended regular expression - ERE)<br> ביטוי זה מוגדר על-ידי תקן POSIX ומוסיף יכולות כגון שימוש בסוגריים לקיבוץ ו- "**+**" עבור "*אחד או יותר*".זה משמש לעתים קרובות בתוכניות C. כך למשל, "**[B-D]+**" פירושו "*אחת או יותר מהאותיות B, C או D*".

3. ביטויים רגולריים תואמי Perl (Perl Compatible Regular Expressions - PCRE)<br>זוהי בעיקר הרחבה של תבנית ERE; שפות תכנות רבות אחרות משתמשות במשפחה זו של שפות רגאקס (regex). הוא כולל יכולות כמו "**\d**" לייצוג ספרות.

הנה כמה דברים חשובים שמשתנים:

* לפעמים יש אפשרות או שיטה חלופית כדי להתאים את הקלט כולו; אם אפשרות זו זמינה, באפשרותך להשתמש בה במקום בסימני העיגון. עם זאת, יש לודא שהוא תואם את כל הקלט; שיטות מסוימות בודקות רק את ההתחלה.

* לפעמים "**^**" תואם את ההתחלה של הנתונים המלאים, בעוד שבאחרים הוא מייצג את ההתחלה של כל שורה בנתונים. כנ"ל לגבי "**$**". זה נשלט לעתים קרובות על ידי האפשרות *לריבוי שורות*.

* ה"**.**" עבור ייצוג *"כל תו"* לא תמיד תואם את תו השורה החדשה (**\n**); לעתים קרובות יש אפשרות להפעיל או לכבות זאת.

* האם הוא תומך כראוי ביוניקוד (Unicode) ובקידוד שבו משתמשים?

* האם הוא יכול לטפל בנתונים עם תו **NUL** (ערך בית 0) בתוך הנתונים? אם לא, ונתוני הקלט שלך עשויים לכלול תו **NUL** מוטבע , יהיה עלינו לאמת תחילה את הנתונים כדי לוודא שאין תווי **NUL** לפני העברת הנתונים ליישום רגאקס (regex).

* האם התאמה היא תלוית אותיות גדולות וקטנות? בדרך כלל זה אכן תלוי אותיות גדולות וקטנות כברירת מחדל, ויש דרך טריוויאלית להפוך אותו לחסר רגישות לכך. אם הוא אינו רגיש לאותיות גדולות וקטנות, זיכרו כי לאילו תווים בדיוק יש התאמות רגישות לאותיות גדולות וקטנות תלויה בהתאמה אזורית. לדוגמה, "**I**" ו- "**i**" תואמים באנגלית ("**en**") ובהתאמה אזורית C ("**C**"), אך לא בטורקית ("**tr**"). בהתאמה אזורית טורקית, האות הגדולה הלטינית Unicode I תואמת את האות הלטינית הקטנה DOTLESS I - ולא את האות הקטנה "**i**".

בשפות מסוימות, כגון ב- Ruby, משתמשים בדרך כלל ב- **\A** ו- **\z** במקום ב-  “**^**” ו- “**$**” כדי להתאים התחלה/סיום של מחרוזת, מכיוון ש- “**^**” ו - “**$**” תואמים להתחלה/סיום שורה במקום זאת.

#### עדיפות בראנץ' (branch)

כמעט כל יישומי רגאקס (regex) תומכים *בבראנצ'ים (branches)* - כלומר,“**aa|bb|cc**” תואם **aa**, **bb** או **cc**. כל יישומי ERE ו- PCRE תומכים בבראנצ'ים (branches), ואפילו חלק מיישומי BRE תומכים בבראנצ'ים (branches) אם הם כתובים כ- “**&#92;|**” במקום "**|**". העדיפות של פעולת הבראנץ' (branch) היא סטנדרטית, אבל זה לא מה שחלק מהמשתמשים והמשתמשות מצפים. הרגאקס (regex) “**^aa|bb$**” פירושו "*או שזה מתחיל עם aa או שזה נגמר עם bb*", לא *"בדיוק aa או bb*".כאשר משתמשים ברגאקס (regexes) לאימות קלט, רצף של בראנצ'ים (branches) שאינו מוקף בסוגריים הוא כמעט תמיד טעות. מה שבדרך כלל רוצים זה "**^(aa|bb)$**" שפירושו "*בדיוק aa או bb*".

**🚩 לכן, בכל פעם שקיים בראנץ' (branch) ("|") ברגאקס (regex), יש לקבץ את הביטוי כולו עם הבראנצ'ים (branches) באמצעות סוגריים.**

#### בדיקת מאמתי קלט

שוב, עליך לדעת מה התוכנה שלך לא צריכה לקבל, ולהשתמש בחלק מהדוגמאות הללו כמקרי בדיקה אוטומטיים כדי להבטיח שהתוכנה שלך תדחה אותן כראוי. זה חשוב במיוחד עם רגאקס (regexes), כי קל לכתוב רגאקס (regex) שנראה בסדר אבל מאפשר קלט שלא היה מיועד לאפשר אותו. זה יכול לעזור לך לתפוס, למשל, עוגנים חסרים או כשלים להקיף בראנצ'ים (branches) בסוגריים.

#### חידון 1.4: שימוש בביטויים רגולריים לאימות קלט טקסט

\>\>איזה מהבאים מתאים רק ל"אות לטינית אחת או יותר" באמצעות ביטוי רגולרי מורחב (Extended Rgular Expression) (בהינתן התאמה אזורית POSIX)?<<
...
זיכרו, **^...$** נדרשים כדי להפוך את הביטוי לאלאווליסט (רשימת היתרים, allowlist) (הטקסט *חייב* להתאים לתבנית), ו- “**+**” פירושו "*אחד או יותר*".

[הסבר]

### התמודדות עם התקפות רידוס (ReDoS) על ביטויים רגולריים

בעת הוספת קוד, קיים סיכון שלקוד שנוסף יש פגיעות. הדבר נכון במיוחד כאשר מוסיפים קוד שאמור לסייע בשמירה על אבטחת התוכנה, מכיוון שבהגדרה, בעיות בקוד זה עלולות להוביל לבעיית אבטחה.

אם נוסיף בדיקות אימות קלט באמצעות ביטויים רגולריים - גישה נפוצה ומועילה - יש סוג של פגיעות שבאפשרותך להוסיף שלא במתכוון הנקראת פגיעות *מניעת שירות של ביטוי רגולרי, רידוס (ReDoS).* אם התוכנה כוללת פגיעות של רידוס (ReDoS), תוקפים יכולים לכפות מצבים שבהם ניתן להפעיל את הביטוי הרגולרי במשך זמן רב במיוחד (ייתכן ימים או שנים). התוצאה היא מניעת שירות, דינייל אוף סרוויס (דוס, DoS) - ייתכן שההתקפה תוכל לשלוח כמות קטנה של נתונים ולגרום לשירות להיות לא זמין! זה לא רק תיאורטי. בשנת  2020, חבילת **websocket-extensions, הרחבות וובסוקט** וגרסת רובי שלה נמצאו כי יש  את הפגם הזה (אלה קיבלו את המזהים  [CVE-2020-7662](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-7662) ו [CVE-2020-7663](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-7663) בהתאמה).

הסיבה שפגיעות רידוס (ReDoS) אפשרית היא שלרוב יישומי רגאקס (regex) יש מורכבות אשר במקרה הגרוע ביותר גדלה באופן אקספוננציאלי בהתבסס על גודל הקלט. קצת רקע עשוי לעזור כאן. ישנן שתי גישות עיקריות ליישום רגאקס (regexes): *אוטומט סופי דטרמיניסטי (DFA)* או *אוטומט סופי לא דטרמיניסטי(NFA)*. DFAs הם מהירים, בין השאר משום שהם לעולם אינם חוזרים לאחור, ו- DFAs חסינים מפני פגיעויות רידוס (ReDoS). אבל DFAs מוגבלים גם במה שהם יכולים לעשות. בפועל, רוב יישומי רגאקס (regex) כיום הם NFAs, ו- NFAs *פגיעים* פוטנציאלית להתקפות רידוס (ReDoS).

יישומי NFA של רגאקס (regexes) - וזה רובם - *עוקבים לאחור, בקטראק (backtrack)* בכל פעם שהם נכשלים עבור התאמה מסוימת עד שהם מוצאים התאמה או ניסו את כל האפשרויות. בקיצור, במקרה הגרוע ביותר הם מנסים את *כל* השילובים. עבור דפוסי ביטוי רגולריים רבים המקרה הגרוע ביותר אינו מהווה בעיה. עם זאת, סוגים מסוימים של דפוסי רגאקס (regex) יכולים להפוך את המקרה הגרוע ביותר הזה לרע ממש. בפרט, בואו נדמיין שאנחנו מספקים דפוס שבו:

1. תבנית רגאקס (regex) משתמשת בחזרה על תת-ביטויים מורכבים (השימוש ב- "**+**" ו- "**&#42;**" על תת-ביטויים מורכבים), ו-

2. בתוך תת-ביטויים חוזרים אלה, ישנם סימני חזרה וביטויים נוספים התואמים סיומת של התאמה אחרת. ([OWASP ReDoS](https://owasp.org/www-community/attacks/Regular_expression_Denial_of_Service&#95;-&#95;ReDoS))

דוגמה טריוויאלית היא תבנית רגאקס (regex) "**^(a+)+$**". בואו נדמיין שתוקף סיפק את ערך הקלט "**aaaaX**". NFA יתאים את האות הראשונה "a" עם "**a**" בתבנית בקלות, אבל אז ליישום הרגאקס (regex) יש שתי אפשרויות: האם צריך לנסות להחיל את  "+" *הפנימי* או *החיצוני* “**+**” על האות הבאה? רוב המימושים ינסו תחילה את הפנימי, ולאחר מכן יעקבו לאחור לפי הצורך. במקרה הגרוע ביותר, NFA צריך לנסות את *כל* השילובים האפשריים. לכן, כדי לקבוע אם הקלט "**aaaaX**" תואם את תבנית הרגאקס, (regex) NFA צריך לנסות 16 נתיבים אפשריים (כל האפשרויות), כאשר כל אחד מהם נכשל בסופו של דבר בגלל הסיומת **"X"**.אם התוקף מספק את הקלט "**aaaaaaaaaaaaaaX**" יהיו 65536 נתיבים אפשריים, כאשר מספר הנתיבים יוכפל עבור כל "**a**" נוסף. אם תוקף סיפק 80 '**a**' ואחריו **X**, שרשור זה ינסה לעבד את כל הצירופים, מה שייקח כל כך הרבה זמן שהוא יהפוך למניעת שירות.

אנו משתמשים במונח *רגאקסים פגיעים, vulnerable regexes* עבור תבניות רגאקס (regex) עם התנהגות שכזו במקרה הגרוע ביותר. מונח נפוץ בתעשייה לדפוסים אלה הוא *רגקסים מרושעים, איוויל רגאקס (evil regexes)*. זה לא שהרגקס מסופק על ידי תוקף בהכרח, זה פשוט שההתנהגות הגרועה ביותר שלהם היא "רעה" וזה הופך אותם לפגיעים להתקפה. מונח נוסף להתנהגות זו הוא *מעקב לאחור קטסטרופלי.*

ישנם פתרונות רבים לבעיה זו, כולל הדברים הבאים:

1. השתמשו ביישום רגאקס (regex) המשתמש ב- DFA. יישומים מבוססי DFA אינם פגיעים לבעיה זו. לדוגמה, באקוסיסטם של NPM, "**re2**" מיישם מנוע regex של DFA. עם זאת, מנועי רגאקס (regex) מבוססי DFA הם בדרך כלל בעלי יכולת פחותה ובסביבות רבות הם הרבה יותר קשה להתקנה ולשימוש, ולכן זה לעתים רחוקות בשימוש.

2. שנו את הרגאקס (regex) כך שלא תהיה לו התנהגות זו במקרה הגרוע ביותר. זו הגישה הרגילה. היזהרו במיוחד מכל קבוצה "**(...)** " המכילה ענף ו/או המסתיימת בחזרה ואשר בעצמה חוזרת על עצמה.

    1. אם יש חזרה או הסתעפות ברגאקס- (regex) שהיא עצמה חוזרת על עצמה, כיתבו מחדש את הרגאקס- (regex) כך שהתו הבא בקלט יקבע באופן חד משמעי אם החזרה ממשיכה או לא. לדוגמה, לשכתב את "**^(a+)+**$" כ- "**^a+$**".

    2. גישה אחרת היא להשתמש במנגנונים שאומרים למנוע הרגאקס (regex) לא לעקוב אחורה; ליישומי רגאקס (regex) רבים יש *קוונטיפיירים רכושניים (פוזסיב קוונטיפיירים, possessive quantifiers)* ו/או *קיבוץ אטומי (אטומיק גרופינג, atomic grouping)* שיכולים למנוע מעקב אחורי מיותר.

    3. הימנעו מחזרה בלתי מוגבלת. לדוגמה, הגדירו ספירות חזרות מרביות (לדוגמה, **{0,5}**) כך שההתנהגות במקרה הגרוע ביותר תהיה מוגבלת מאוד.

    כלים מסוימים בוחנים קוד מקור כדי לזהות רגאקס (regexes) עם בעל התנהגויות במקרה הגרוע ביותר (אלה עשויים להיות כלים עצמאיים או חלק מכלים גדולים יותר).

3. היכן שניתן, הגבילו תחילה את האורך המרבי של מחרוזות קלט ובידקו תחילה את אורך הקלט. אם הקלט חייב להיות קצר, הגידול האקספוננציאלי בזמן עדיין יסתיים ככמות זמן כוללת קטנה.

4. יישמו פסק זמן, ברגאקס- (regex) (אם נתמך) או ביישום בכללותו. לדוגמה, [Ruby 3.2](https://www.ruby-lang.org/en/news/2022/04/03/ruby-3-2-0-preview1-released/) תומך בהשמת ערך פסק זמן גלובלי בשם regex (`Regexp.timeout`) ובפרמטר פסק זמן בעת יצירת אובייקט מסוג ביטוי רגולרי. [מנגנוני MatchTimeout של .NET framework](https://docs.microsoft.com/en-us/dotnet/api/system.text.regularexpressions.regex.matchtimeout) יכולים גם להגדיר ערך פסק זמן כללי או ערך זמן קצוב עבור כל רגאקס (regex).

5. אל תפעילו רגאקס (regexes) המסופקים על ידי תוקפים במערכות שאינן משלהן. זה בסדר אם היריבים יספקו רגאקס (regex) שהם עצמם יריצו תמיד (במקרה זה, התוקפים פשוט יתקפו את עצמם). אך אם תוקפים יכולים לספק רגאקס (regexes) שאנחנו מפעילים, ייתכן שהם יוכלו לגרום לרידוס (ReDOS) (אלא אם כן נקטתנו בצעדים אחרים כדי למנוע זאת). ביטויים רגולריים, רגאקס (regex) הם, באופן כללי, שפות תכנות, ובדרך כלל עלינו להימנע מהפעלת תוכניות המסופקות על-ידי התוקף. אפשר לעשות את זה בצורה מאובטחת יחסית, אבל צריך לנקוט לכך הרבה אמצעי זהירות וזה תמיד בטוח יותר פשוט לא לעשות את זה.

לפרטים נוספים, עיינו [בדיון OWASP](https://owasp.org/www-community/attacks/Regular_expression_Denial_of_Service&#95;-&#95;ReDoS) על כך.

הערה: רידוס (ReDoS) הוא לעתים קרובות *לא* נקודת תורפה אמיתית. ביטויים רגולריים, רגאקס (regex) כאלה יכולים להיות פגיעות *רק אם* הם פועלים על מערכת מהימנה ומעבדים קלט לא מהימן. ישנם כלים רבים שיכולים לזהות רגאקס (regexes) הפגיעים לרידוס (ReDoS) אך הם אינם קובעים אם מקורות הקלט אינם מהימנים. כלים כאלה יכולים להציף מפתחים במה שמכונה "פגיעויות" שאינן באמת פגיעויות. בנוסף, במקרים מסוימים אמצעי נגד (כמו גדלי קלט מרביים ופסקי זמן) מבטלים ביעילות את יעילות הרידוס (ReDoS). גם כאשר רגאקס (regex) מעבד קלט לא מהימן ואמצעי נגד אלה נכשלים, רידוס (ReDoS) *לכל היותר* יגרום למניעת שירות, לא לאובדן סודיות או יושרה (confidentiality or integrity). לכן, בעוד שרידוס (ReDoS) יכול להוות נקודת תורפה אמיתית, לעתים קרובות הוא אינו מהווה נקודת תורפה או שהוא פחות חשוב. כאשר מתמודדים עם מספר רב של דוחות פגיעות של רידוס (ReDoS), כדאי לבדוק שוב אם אלה פגיעויות אמיתיות.
(ראו  [של Enosuchblog "פגיעויות" ReDoS ותמריצים לא מיושרים"](https://blog.yossarian.net/2022/12/28/ReDoS-vulnerabilities-and-misaligned-incentives).)

#### חידון 1.5: התמודדות עם התקפות רידוס (ReDoS) על ביטויים רגולריים

\>\>אילו מבין אלה הן *דרכים מעשיות* למתן התקפות רידוס (ReDoS)? ביחרו את כל התשובות הרלוונטיות.<<

[!x] השתמשו במנגנון ביטוי רגולרי שאינו משתמש במעקב לאחור (כלומר, DFA).

[x] במידת האפשר, כיתבו רגאקס (regexes) שאין להם את ההתנהגות במקרה הגרוע ביותר. לדוגמה, היזהרו מחזרות בתוך חזרות.

[x] הגבילו את הגודל המרבי של הקלט, כך שגם ההתנהגות במקרה הגרוע ביותר לא תהיה כל כך גרועה.

[ ] אף אחד מהנ"ל

## אימות קלט: מעבר למספרים וטקסט

### דה-סריאליזציה לא בטוחה (Insecure Deserialization)

אל תאפשרו קבלת תבניות נתונים מורכבות יותר. במקום זאת, ודאו שאפילו קבלת קלט זה ממקור שאינו מהימן, לא תגרום לבעיית אבטחה.

בעיה מסוכנת היא דה-סריאליזציה לא בטוחה (Insecure Deserialization).  **דה-סריאליזציה** היא תהליך של  המרת רצף כלשהו (של בתים או תווים) לתבנית פנימית כלשהי; תהליך זה עשוי ליצור מספר אובייקטים. דה-סריאליזציה יכולה לקרות בעת קריאת נתונים מרשת או מאחסון, כי בשני המקרים יש צורך להפוך רצף של בתים או תווים לפורמט פנימי. למרבה הצער, דה-סריאליזציה (deserialization) יכולה לגרום לבעיות חמורות, כי אם המקור אינו מהימן, אז תוקף עשוי לספק רצף שעבר מניפולציה:

1. ייתכן שהנתונים יומרו לערך בלתי צפוי שאין לסמוך עליו. לדוגמה, ייתכן שזהו ערך מובנה של קובץ קוקי (Cookie) שבמקור קבע כי  **admin=n**, אך התוקף עשוי לשנות את הערך ל **admin=y**. אם התוכנה קיבלה נתונים אלה באופן עיוור, התוקף עלול להפוך לפתע למנהל המערכת, אדמיניסטרטור (administrator)!

2. דה-סריאליזציה עלולה לגרום לביצוע קוד, לדוגמה, היא עלולה ליצור מחלקות או מופעים ו/או לקרוא למטודות (methods) שנבחרו על-ידי התוקף עם ארגומנטים שסופקו על-ידי התוקף. זוהי בעיה בעיקר עבור פורמטים המיועדים לשמירה כלשהי של אובייקטים. דוגמה לכך היא פורמט פיקל (pickle), אשר מבצע באופן אוטומטי קוד במקרים מסוימים בעת דה-סריאליזציה של נתונים.

**הפתרון הבטוח ביותר הוא לא לקבל אובייקטים הדורשים דה-סריאליזציה ממקורות לא מהימנים.**

אם עליך לקבל אובייקטים הדורשים דה-סריאליזציה ממקורות לא מהימנים, באפשרותך להשתמש בתבניות סריאליזציה שאינן תומכות בביצוע קוד. לדוגמה, ניתן להשתמש בתבניות סריאליזציה המאפשרות רק סוגי נתונים פרימיטיביים. פתרון זה נוגד את הבעיה השנייה - ביצוע קוד - אבל כשלעצמו, אינו פותר את הבעיה הראשונה - ערכים בלתי צפויים. לכן, לאחר בחירת גישה למניעת ביצוע קוד, יש לאמת את הקלט שקיבלת באמצעות הגישות שכבר דנו בהן.

במקרים מסוימים, באפשרותך למנוע התקפות דה-סריאליזציה (deserialization) באמצעות בדיקות אימות, אוטנטיקציה (authentication). בעיקרון זוהי הפיכת נתונים לא מהימנים לנתונים מהימנים! לשם כך, לפני ביצוע דה-סריאליזציה של הנתונים, יש להפעיל בדיקת אימות כדי לוודא שהנתונים מגיעים ממקור מהימן. דרך נפוצה לעשות זאת היא על-ידי בדיקת חתימה דיגיטלית, הודעת קוד אימות (message authentication code, MAC), הצפנה מאומתת או אמצעי דומה. גישה זו נפוצה במיוחד ביישומי אינטרנט; לעתים קרובות, שרת אינטרנט ישלח נתונים ללקוח, כך שהלקוח יוכל לשלוח אותם מאוחר יותר בחזרה (לדוגמה, כקובץ Cookie). גישה זו היא בסדר כל עוד שרת האינטרנט מוודא את שלמות הנתונים (כדי למנוע את יצירתם ע״י תוקף או חבלה בהם) *לפני* ביצוע דה-סריאליזציה.

יש שממליצים לאכוף אילוצים על טיפוסי המחרוזת (string type constraints) (למשל, לאפשר רק למחלקות מסוימות לעבור דה-סריאליזציה). למרבה הצער, לטכניקה זו נמצאו מעקפים רבים לאורך השנים. זה רעיון טוב כטכניקת *הקשחה* (או פשוט כדרך לזהות באגים מוקדם). עם זאת, במערכות רבות, זה כנראה מסוכן מדי להמליץ כהגנה נאותה בפני עצמה.

 דה-סריאליזציה לא מאובטחת היא טעות נפוצה כל כך ביישומי אינטרנט כי היא #8 2017 OWASP Top 10, ו #13 2021 CWE Top 25, ו #23 2019 CWE Top 25. זוהי [CWE-502](https://cwe.mitre.org/data/definitions/502.html), *דה-סריאליזציה של נתונים לא מהימנים*. נחשב גם לחלק מ #8 2021 OWASP Top 10 (A08:2021), *כשלי תוכנה ותקינות נתונים*. התוקפים עשויים למצוא פגיעויות כאלה קשות יותר לניצול, אך ברגע שהפגיעות מתגלה היא עלולה לגרום לפגיעה מיידית במערכת שלמה, מכיוון שהיא עלולה לספק שליטה מלאה במערכת לתוקף.

#### חידון 1.6: דה-סריאליזציה לא בטוחה

\>\>אחד הסיכונים הגדולים בדה-סריאליזציה של נתונים הוא שבהתאם לתבנית הסריאליזציה, הנתונים עלולים לגרום להפעלת קוד המוגדר על-ידי התוקף. אמת או שקר?<<
...
כמובן, לפעמים תוכנה צריכה לקבל מבני נתונים מורכבים נפוצים, כגון XML, HTML, JSON ו- CSV. מאחר ואלה הם פורמטים נפוצים, כדאי לדבר עליהם.

בעוד שמבחינה טכנית מדובר במחרוזות, במציאות מדובר במחרוזות בעלי מבנה פנימי משלהם ומורכב יותר. לעתים קרובות עדיף להשתמש בספריות שתוכננו במיוחד לטיפול בתבניות קלט אלה, כל עוד הן מיועדות לטפל בקלטים שעלולים להיות זדוניים. בדרך כלל עליך לנסות לזהות ולדחות מבני נתונים שאינם תקפים מבחינה תחבירית, ולאחר מכן, במידת הצורך, לבדוק שהם עומדים בסכימה ספציפית שהם אמורים לעמוד בה. באופן אידיאלי, ספריות אלה יאפשרו לך לציין רק את מה שברצונך לקבל, ולדחות את כל השאר. אם מנגנונים אלה אינם יכולים לאמת את הקלט באופן מלא, יש להשלים זאת עם אימות כל קלט שצריך כדי להבטיח שרק נתונים חוקיים יתקבלו.

#### .XML

נתונים והודעות רבים מקודדים ב- XML (Extensible Markup Language, שפת סימון מורחבת). XML הוא חלק מתבניות אחרות, כגון SOAP (Simple Object Access Protocol, פרוטוקול גישה לאובייקט פשוט). ישנם שני מונחים אודות XML אשר יוצרים לרוב בילבול:

* **בנוי היטב, Well-formed**<br>XML בנוי היטב היטב עוקב אחר כללי תחביר מסוימים. לדוגמה, כל התגים שנפתחו חייבים להיות סגורים, ורכיבי XML חייבים להיות מקוננים כראוי. אם מתקבל XML, יש לודא *לפחות* שה- XML בנוי היטב; יש ספריות זמינות בקלות עבור זה, ויישומים אמורים לקבל רק XML בנוי היטב.

* **חוקי או וולידי, Valid**<br>XML חוקי עונה על הגדרת סכימה כלשהי. הסכימה מציינת מידע כגון *אילו* תגים מותרים, כיצד הם עשויים להיות מקוננים ואם חלקם נדרשים. הגדרת סכימה, אם היא קפדנית, היא סוג של רשימת התרה. לכן, בדיקת חוקיות לפני קבלת קלט XML יכולה להיות שימושית מאוד להתמודדות עם התקפות. עם זאת, *איו* לאפשר לתוקף לקבוע באיזו סכימה להשתמש - יש להחליט איזו סכימה בסדר ולהשתמש *רק בה*. לפעמים אין סכימה זמינה, ואם מחלצים רק חלק קטן של XML, ייתכן שלא כדאי ליצור סכימת XML.

אם משתמשים ב- XML, קיימת פגיעות נפוצה ביותר שעליך להתמודד איתה הנקראת ישויות חיצוניות של XML (XML External Entities, XXE). כדי להבין אותה, צריך להבין פונקציונליות XML שאינה מוכרת לרוב.

XML תומך בהפניות חיצוניות שניתן לטעון באופן אוטומטי בעת טעינת המסמך המקורי. ההפניה החיצונית יכולה להיות כל מיקום קובץ או כתובת URL. משמעות הדבר היא שתוקף יכול לספק קבצים שגורמים בשקט לטעינה ולמיקום של קבצים או כתובות URL אחרים במקומות מסוימים. פונקציונליות זו קיימת מסיבה כלשהי, ומערכות מסוימות תלויות בה באופן לגיטימי. עם זאת, למפתחים ומפתחות רבים אין מושג כי זה אפשרי, וזה הוביל פגיעויות רבות. להלן דוגמה למסמך XML עם ישויות חיצוניות מוטבעות:
...
באופן כללי, אין לקבל הפניות חיצוניות לא בדוקות ממקורות לא מהימנים. הנה כמה פתרונות אפשריים:

* קיבעו את תצורת קורא/מעבד ה XML כך שיתעלם או ידחה הפניות חיצוניות. הקפידו לבדוק, בבדיקות האוטומטיות שלכם, שעדיין מתעלמים ממנו! מכיוון שרוב היישומים אינם משתמשים בישויות חיצוניות, זהו בדרך כלל הפתרון הקל ביותר.

* לאסור או לבדוק (עם רשימת התרה) כל הפניה חיצונית לפני השימוש.

* אל תשתמשו ב- XML, כולל פורמטים כגון SOAP המשתמשים ב- XML. לפורמטים אחרים, כמו JSON, אין את המנגנון הזה ולכן לא יכולה להיות בעיה זו.

לקבלת מידע נוסף אודות בעיה זו, עיינו ב [דף האינטרנט ישויות חיצוניות של OWASP XML](https://owasp.org/www-פרוייקט-top-ten/2017/A4_2017-XML_External_Entities_(XXE).html).

 XML XXE היא טעות כה נפוצה ביישומי אינטרנט שהיא #4 2017 OWASP Top 10, #23 2021 CWE Top 25, ו- #17 2019 CWE Top 25. הוא מזוהה גם כ- [CWE-611](https://cwe.mitre.org/data/definitions/611.html), *הגבלה לא נאותה של הפניה לישות חיצונית של XML*.

#### .HTML

בדרך כלל אפשר פשוט להשתמש בספרייה כדי לאמת HTML ולהעביר קבוצה של תגים מותרים (למשל,**&lt;p&gt;**) ותכונות (למשל, **href=**). כל מה שאסור יש להסיר או לדחות. זה יבטל תגיות מסוכנות כמו **&lt;script&gt;**  ממקורות חיצוניים (בהנחה שלא כוללים תגים מסוכנים בקבוצת התגים המותרים).

למרות שזה נושא גדול בפוטנציה, בפועל, המפתח הוא לעתים קרובות להשתמש בספריה עם ברירות מחדל מאובטחות כהוגן. אם מאפשרים רק תגים כגון **&lt;p&gt;**, **&lt;i&gt;**, ו **&lt;b&gt;** ומגבילים תכונות (attributes) לערכים כגון **id**, כמות הנזק שניתן לעשות מוגבלת מאוד.,

#### .CSV

הפורמט מסוג CSV, "ערך מופרד פסיקים" הוא בתיאוריה פשוט. כל שורה היא רשומה, שבה השדות מופרדים בפסיקים. השורה הראשונה היא בדרך כלל "שורת כותרת" - שמות השדות מופרדים על ידי פסיקים (תמיד צריך לספק את הכותרת, שכן זה עושה את קובץ ה- CSV יותר קל להרחבה ולשילוב עם כלים אחרים).
...
בעת קריאת תבניות אלה ממקור לא מהימן, יש לודא שכל תא עומד בתבנית הנתונים הצפויה, ולא להעביר את הנתונים אחרת. יש להיזהר במיוחד מתאים המתחילים ב- "**=**", ולנסות להימנע מהעברתם הלאה, מכיוון שכלים מסוימים עשויים לבצע את תוכנם.

#### ג'ייסון (JSON)

ל- JSON אין את היכולת המובנית להכיל ישויות חיצוניות או ביטויים שכלים רבים היו מצפים שיבוצעו, מה שהופך אותו ליתרון מנקודת מבט אבטחתית. ישנם כלים שיכולים לאמת בקלות את תחביר ה JSON, ותהליך זה מיושם לעתים קרובות כחלק מקריאת JSON לתוך פורמט פנימי.

אם רוצים ללכת רחוק יותר, ישנם פורמטים כגון סכימת ג'ייסון (JSON Schema) המאפשרים לך להגדיר בקפדנות רבה יותר בדיוק את הפורמט של פורמט JSON נתון. לאחר מכן אפשר להשתמש במאמתי סכימת JSON כדי לוודא שהנתונים תואמים לסכימה.

#### העלאות קבצים

לפעמים צריך לקבל העלאות קבצים של סוגי קבצים מיוחדים (למשל, של תמונות).

אם התוכנה מאפשרת העלאות, נסו להגביל העלאות לסוגי קבצים ספציפיים וודאו (הן באמצעות סוג MIME והן באמצעות התוכן) שהקובץ הוא אחד מהסוגים החוקיים שיתקבל. הגבילו גם את מה שאתם מתירים בשם הקובץ; תווים אלפאנומריים הם בדרך כלל בסדר, אבל כל דבר אחר (במיוחד "**/**" ו- "**&#92;** ") יכול להיות בעייתי, לכן נאפשר רק את התווים שאנחנו בטוחים שיהיו בסדר. במידת האפשר, הגדירו רשימה מקובלת של סיומות שמות קבצים מותרות, ואפשרו העלאות של קבצים בשם אחד מהסיומות המותרות.

 הגבלה לא מספקת של העלאות היא סיבה כה נפוצה לפגיעויות אבטחה שהיא #10 2021 CWE Top 25 ו- #16 2019 CWE Top 25. היא מזוהה כ- [CWE-434](https://cwe.mitre.org/data/definitions/434.html), *העלאה בלתי מוגבלת של קובץ מטיפוס מסוכן*.

#### חידון 1.7: מבני נתוני קלט (XML, HTML, CSV, JSON והעלאות קבצים)

\>\>בעת קריאת נתונים בתבניות נתונים נפוצות כגון XML ו- JSON, העדיפו להשתמש בספריות שנועדו לטפל בהם באופן מאובטח, נסו לדחות מבנים שאינם תקפים מבחינה תחבירית, ולאחר מכן, כאשר הדבר מעשי, בדקו שהם עומדים בסכימה ספציפית כלשהי הדרושה לכם. אמת או שקר?<<
...
בפרק תכנון המערכת (אשר בחלקו הראשון של קורס זה), ציינו כי חשוב למזער  את *משטח התקיפה* - כלומר, את הממשקים שהתוקף יכול לקבל גישה אליהם. אין פירוש הדבר "הגבילו את הממשקים שבהם אתם *מתכוונים* שמשתמשים ישתמשו"; *היישום* חייב להגביל את הממשקים שלתוקף יש גישה אליהם. נסו לעשות את זה כך שהתוקפים לא יוכלו אפילו *לגשת* לרוב הממשקים, ואז להגן בזהירות על הממשקים הנגישים.

עם זאת, במערכות רבות, התוקפים יוכלו לנסות כמה בקשות. במקרים אלה, יהיה עליך לוודא שהבקשה מאושרת (מותרת) לפני שהיא מכובדת. יש לזכור, הרשאה פירושה קביעה אם בקשה זו מותרת לאותו אדם או תוכנה.

צריך *לבדוק* אם בקשה מאושרת *בכל מקרה*. כלומר, לוודא שבדיקות ההרשאה אינן ניתנות לעקיפת. כלים לרוב אינם טובים בקביעה אם כל בקשה נבדקת לאישור, כך שבדרך כלל צריך להסתמך בעיקר על בדיקה אנושית. אם בני אדם יכולים לראות בקלות שבדיקת ההרשאה הנכונה נעשית עבור כל בקשה, לוקח הרבה פחות זמן לבדוק אותה *וכן* סביר יותר שהיא נכונה. בפועל, לעתים קרובות זה אומר שתוכנות צריכות לבדוק אישור ברגע שאפשרי לעשות זאת באופן סביר. המשמעות המדויקת של זה תלויה במערכת שלך, לדוגמה, בארכיטקטורת מודל-תצוגה-בקר (model-view-controller), אפשרי לבצע בדיקות הרשאה בכל ערך בקר (controller entry) ו/או בכל ערך מודל (model entry). מה שחשוב הוא שזה נעשה בעקביות ושקל לאחרים לוודא שלא ניתן לעקוף את זה. באופן דומה, יש לאחסן את הנתונים כך שרק בקשות מורשות יוכלו להצליח.

 הרשאה לא מספקת היא טעות נפוצה כל כך *שבקרת גישה שבורה* היא #5 2017 OWASP Top 10 ו- #1 2021 OWASP Top 10. *הרשאה שגויה היא #38 2021 CWE Top 25 ו- #33 2019 CWE Top 25 (CWE-863)*, [והרשאה חסרה](https://cwe.mitre.org/data/definitions/863.html) היא #18 2021 CWE Top 25 ו- #34 2019 CWE Top 25 ([*CWE-862*](https://cwe.mitre.org/data/definitions/862.html))

כמובן, אם משהו דורש אישור, זה אומר שהיה צריך להיות קודם כל לבצע איזשהו זיהוי ואימות (I&amp;A) על מנת לוודא שהבקשה היא ממי שהם טענו שהם. יש לבדוק ביסודיות כיצד האימות מטופל, והיכן שהדבר מעשי, להשתמש בשירותים, ספריות או תשתיות (frameworks) מוכרות כדי לעשות זאת.

בדרך כלל יש לבצע תחילה אימות קלט של זהות (כגון שם משתמש או כתובת דוא"ל), לפני שעושים איתה כל דבר אחר, כדי להפחית את הסבירות שתוקף יחתור תחת מערכת באמצעות מערכת הכניסה שלו. ברוב המקרים יש לדווח רק על "הכניסה נכשלה" (או נוסח דומה) אם השילוב של הזהות והאימות (כגון סיסמה) נכשל; אין לחשוף אם הזהות קיימת במערכת, מכיוון שזה מאפשר לתוקף לדעת אם הזהות קיימת במערכת. יש לתמוך בכניסות עם אימות רב-גורמי (MFA), ישירות או באמצעות שירות, מכיוון שהן נוטות להיות חזקות יותר בסיסמאות.

אם תומכים בסיסמאות לאימות, פעלו לפי שיטות עבודה מבוססות, לדוגמה:

1. ודאו שלא יותר מתוו אחד של סיסמה מוצג למשתמש בכל פעם, כדי להפחית את הסיכון שמישהו אחר יוכל לראות את הסיסמה (המכונה "גלישת כתפיים", “shoulder surfing”). יש אפשרות לעשות זאת בשדות קלט HTML באמצעות סוג הקלט `password`.
2. יש לודא שמשתמשים יכולים להשתמש במנהלי סיסמאות בעת כניסה, יצירת סיסמה או שינוי סיסמה. לדוגמה, ודאו שמשתמשים יכולים להעתיק טקסט לשדות הסיסמה, מכיוון שפונקציונליות זו נחוצה עבור מנהלי סיסמאות מסוימים. אילוץ משתמשים להקליד סיסמאות באופן ידני מעודד אותם להשתמש בסיסמאות גרועות ומרתיע אותם מלהשתמש במנהל סיסמאות (שנחשב לשיטת עבודה מומלצת על ידי רבים).
3. בעת יצירה או שינוי של סיסמה, בקשו מהמשתמש להזין את הסיסמה הישנה. פעולה זו מונעת מהתוקף לשנות בקלות את הסיסמה אם יש לו שליטה קצרה על החשבון. כמו כן, בקשו מהמשתמש להזין סיסמה חדשה פעמיים ולוודא שהן זהות, כדי להבטיח שהסיסמה המיועדת תשמש כסיסמה. זה גם מוודא שמנהל סיסמאות (אם בכלל) שולח את הסיסמה באופן עקבי.

כאשר משתמש משנה סיסמה או אישור אחר (כגון אסימוני MFA), שיקלו להודיע למשתמש (למשל על-ידי שליחת דואר אלקטרוני או הודעת טקסט). בדרך זו, אם המשתמש לא גרם לשינוי, המשתמש יקבל על כך התראה מיידית.

 2021 OWASP Top 10 #7 הוא *כשלי זיהוי ואימות*. אימות לקוי הוא טעות נפוצה כל כך *שאימות שבור* הוא #2 2017 OWASP Top 10,  #14 2021 CWE Top 25, ו- #13 2019 CWE Top 25. זה [CWE-287](https://cwe.mitre.org/data/definitions/287.html), *אימות לא תקין*. *אימות חסר עבור (במיוחד עבור) פונקציה קריטית* הוא #11 2021 CWE Top 25 ו #36 2019 CWE Top 25 ([CWE-306](https://cwe.mitre.org/data/definitions/306.html)).
...
### נתיבי חיפוש ומשתני סביבה (כולל תוכנות setuid/setgid)

לעתים קרובות יישומים צריכים לחפש משאבים אחרים, כגון ספריות, פקודות וחבילות. במקרים רבים חיפוש זה נשלט על ידי "נתיב חיפוש" - מיקום או רצף של מיקומים לחיפוש. דוגמה אחת לנתיב חיפוש היא משתנה הסביבה `PATH`, המפרט רצף של ספריות ומשמש בעת חיפוש קבצי הפעלה במערכות דמויות יוניקס ו- Windows. קיימים משתנים סביבתיים רבים אחרים דוגמת `PATH` (למשל, `PYTHONPATH` בפייתון). בנוסף, מערכות רבות אחרות כוללות נתיבי חיפוש, לדוגמה, מנהלי חבילות תומכים בדרך כלל בנתיב חיפוש המציין את המאגרים או הרישומים שמהם ניתן לאחזר חבילות.

אם תוקף יכול לשלוט בנתיב החיפוש, התוקף עלול לעתים קרובות לגרום ליישום להפעיל קוד זדוני, להשתמש בנתונים שבשליטת התוקף או לחשוף נתונים פרטיים. לדוגמה, אם תוקף יכול לשלוט במשתנה הסביבה `PATH`, ייתכן שתוקף יוכל לאלץ את היישום להפעיל תוכניות לא מכוונות. הפתרון הטוב ביותר הוא להבטיח שהתוקף לא יוכל לשלוט בנתיב החיפוש, למשל על-ידי אי-מתן ההזדמנות או על-ידי הגדרת נתיב החיפוש לערך בטוח לפני השימוש בו.

בעיה קשורה היא שנתיב החיפוש עשוי להכיל מיקום שתוקף יכול לשלוט בו או להשפיע עליו באופן בלתי צפוי. לדוגמה, אם למשתנה הסביבה `PATH` יש ערך המוגדר לספריה הנוכחית, כלומר, "." או "" (ריק), והערך מופיע לפני ספריות מהימנות יותר, הספריה הנוכחית תשמש תחילה. הדבר עלול להפוך לפגיעות מכיוון שהתוקף יוכל בסופו של דבר להוסיף תוכן לספריה שהיישום ישתמש בו כספריה נוכחית. במערכות ישנות דמויות יוניקס, הגדרת PATH לא מאובטחת הייתה ברירת המחדל. אחת הדרכים הנפוצות שבהן טעות זו מתרחשת כיום היא אם הנתיב משתנה על ידי שרשור התו המשמש להפרדת הספריות ולאחר מכן הספריה החדשה; אם הנתיב היה ריק מלכתחילה, פעולה זו מוסיפה ערך ריק כערך הראשון. לדוגמה, אם  היה `PYTHONPATH` ריק, שרשור נאיבי של  ":" וספרייה `/usr/share/foo` היה מייצר את " `PYTHONPATH` <tt>:/usr/share/foo</tt>"; שימו לב שהספרייה הריקה מופיעה ראשונה, מה שיתפרש כחיפוש ראשון בספריה הנוכחית. הפתרון במקרה זה הוא להכניס את המפריד רק אם כבר יש שם טקסט.

ישנם מספר אמצעי נגד פוטנציאליים לבעיות בנתיב החיפוש, לדוגמה:

* בעת האתחול, בידקו את נתיב החיפוש שבו תשתמשו (כגון `PATH`) עבור שגיאות נפוצות כגון הכללת ספריה ריקה או "." לפני נתיבים מהימנים יותר (כגון `/usr/bin`). במערכות Windows, בידקו האם מצב חיפוש DLL בטוח מופעל. כדאי לעצור, או לפחות להזהיר, אם הגדרות המערכת הנוכחיות מסוכנות.
* השתמשו בשמות נתיבים מלאים בעת הגשת בקשה (לדוגמה, התקשרות לתוכנות הפעלה, ייבוא ספריות או בקשת חבילות). רוב המערכות התומכות בנתיב חיפוש תומכות גם בפנייה ישירה של הרכיב הספציפי; הגשת בקשה ישירה תבטיח שאתם מבקשים את הבקשה הנכונה. זהו מנגנון הקשחה מתקבל על הדעת, אך קל לשכוח לעשות זאת במקרים מסוימים, וזה אכן מקשה לפעמים על העברת תוכנה בין מערכות.

ערכי תצורה רבים, כולל נתיבי חיפוש רבים, מסופקים באמצעות משתני סביבה. סביבות מסוימות בהן התוכנה מבוצעת, כגון JavaScript בצד הלקוח, אינן כוללות משתני סביבה. ברוב הסביבות האחרות (לקוח ושרת), משתני סביבה קיימים, אך בדרך כלל נחשבים מהימנים (כלומר, משתני סביבה יכולים להיות מוגדרים רק על-ידי מישהו בעל הרשאה להגדיר אותם). עם זאת, ישנם כמה מקרים מיוחדים שבהם האמון בהם צריך להיות מוגבל.
...
עם זאת, יש עוד מקרה מיוחד וחשוב: אם כותבים משהו שנקרא תוכנת **setuid** או **setgid**, אז *משתני סביבה יכולים לבוא מהתוקף*. הקדמה קטנה מתבקשת. מערכות דמויות יוניקס (כולל לינוקס ו-MacOS) מאפשרות להגדיר תוכנות כ **setuid** ו/או **setgid**. כאשר תוכנית **setuid** פועלת, יש לה את ההרשאות של *הבעלים* שלה (לא המבקש שלה). תוכנית **setgid** פועלת עם ההרשאות של *הקבוצה* שלה (לא הקבוצות של המבקש שלה). תוכניות מסוג זה יורשות קלט רב מתוקף פוטנציאלי, כולל ערך הספריה הנוכחי ומשתני סביבה. פתרון אחד הוא לא לכתוב תוכנת **setuid** או **setgid**, כמו במקרים רבים גישה זו אינה נחוצה כיום.

אם *אכן* כותבים תוכנת **setuid**/**setgid**, התוכנה חייבת להגן על עצמה מפני כל הקלטים שלה, וזה כולל את משתני הספריה והסביבה הנוכחיים. משתני סביבה יכולים להיות מסובכים במיוחד, מכיוון שישנן גישות לא בטוחות רבות שנראות בטוחות. הסיבה לכך היא שמשתני סביבה הם בדרך כלל ממקורות מהימנים, ולכן רוב המפתחים אינם מוכנים להתמודד עם המקרה החריג שבו משתני הסביבה *אינם* ממקורות מהימנים. הפתרון הבטוח היחיד הוא (כחלק מההפעלה) לחלץ *רק* את משתני הסביבה הדרושים, לוודא שהערכים שלהם בטוחים, למחוק את *כל* משתני הסביבה ולאפס את המשתנים הדרושים לערכים בטוחים (כולל ערכים בטוחים המסופקים בעת הפעלת התוכנית). מחיקת כל משתני הסביבה ברוב שפות התכנות היא קלה, פשוט הגדר את המשתנה הגלובלי **environ** למצביע null או שווה ערך ([המשתנה **environ** מוגדר בתקן POSIX](https://pubs.opengroup.org/onlinepubs/9699919799/functions/environ.html)). בצעו פעולה זו *מוקדם*, לפני יצירת שרשורים כלשהם. אינכם יכולים פשוט להסיר כמה משתני סביבה; תוקף עלול ליצור מבנה נתונים משתנה של סביבה מוזרה, ויש פשוט יותר מדי משתני סביבה שעלולים להיות מסוכנים (כגון **LD_LIBRARY_PATH**) כדי לנסות למחוק רק ערכים מסוכנים מסוימים. זוהי דוגמה נוספת לרישום התרות (אלאווליסט, allowlisting) במקום הכחשה; אפשרו רק את משתני הסביבה המעטים הדרושים, עם הערכים המותרים שלהם, ולא שום דבר אחר.ודאו שהמשתנים האפשריים היחידים הם אלה שאתם מצפים להם ויש להם ערכים בטוחים עבורם. זה כולל את **PATH** ואת כל משתני הסביבה האחרים.

 נתיב חיפוש לא מהימן הוא סיבה נפוצה כל כך לפגיעויות אבטחה שהוא #22 2019 CWE Top 25. זהו [CWE-426](https://cwe.mitre.org/data/definitions/426.html). *נתיב חיפוש לא מהימן* #34 2021 CWE Top 25 מכסה את *רכיב נתיב החיפוש הבלתי מבוקר הקשור* (*[CWE-427](https://cwe.mitre.org/data/definitions/427.html)).
...
יש קבוצה מיוחדת של קלטים המשמשים לעתים קרובות בעת ההפעלה: מידע תצורה, קונפיגורציה. זה יכול להיות קריטי לאבטחה.

במערכות מודרניות יש רכיבים רבים. התוכנה המפותחת תהיה כנראה חלק קטן ממערכת אחרת הרבה יותר גדולה. אל תצפו שאנשים יקראו בעיון את התיעוד שלכם; הם לא יעשו זאת. במקום זאת, *הקלו* על השימוש בתוכנה שלך באופן מאובטח.

תחילה, יש לודא שהתוכנה שלך *מאובטחת כברירת מחדל*. אם אין מידע תצורה (קונפיגורציה), התוכנה שלך צריכה לעשות את דבר המאובטח (שהוא בדרך כלל למנוע גישה). אם יש קונפיגורציה לדוגמה או קוד לדוגמה המראים כיצד להשתמש בה, יש לודא שגם הדוגמאות מאובטחות (אנשים בדרך כלל מעתיקים ומדביקים דוגמאות בעת שימוש במשהו). אל תיצרו קונפיגורציה לדוגמה המאפשרות *גישה לכולם* , אלא אם כן זה באמת שימוש רגיל. במקום זאת, צרו דוגמאות מגבילות ככל שתוכלו באופן סביר. כללו הערות ברורות רבות בקובץ הקונפיגורציה לדוגמה, אם יש כזה, כך שמנהל המערכת יבין מה עושה התצורה.

אם דוגמאות מאובטחות מסובכות מדי או קשות להסבר, הדבר מצביע על כך שהקונפיגורציה או ה- API שלך מורכבים מדי או כוללים ברירות מחדל שגויות. אל תתקנו רק את התיעוד, תקנו את הקוד כך שיהיה קל יותר להגדיר אותו או להשתמש בו בצורה מאובטחת, ואז יהיה קל יותר ליצור את התיעוד.

קבלו מידע תצורה (במיוחד אם הוא יכול להכיל קוד) ממקור מהימן - לא ממשתמש לא מהימן. אם בונים יישום דסקטופ (desktop) מסורתי, זה בסדר גמור לקבל את התצורה מספריית הבית או מספריית קונפיגורציה בתוכו כמו **$HOME/.config**, אך היזהרו מתצורות או מכל נתון אחר מהספרייה הנוכחית; ייתכן שלמשתמש יש נתונים לא דחוסים מתוקף לספריה הנוכחית. יישומי אינטרנט בצד השרת צריכים להוריד תצורות וקוד רק ממקורות מהימנים (לדוגמה, הספריות המקומיות שלהם). יישומי אינטרנט בצד הלקוח צריכים להשתמש במדיניות אבטחת תוכן (CSP) כדי להגביל את המקומות שבהם הם יכולים לקבל מידע, כפי שנדון בהמשך.

בעת ההפעלה, או אפילו מעת לעת, שיקלו לבדוק שהנחות האבטחה תקפות ולעצור אם הן אינן תקפות. לדוגמה, אם יש גישה לקבצים פרטיים מסוימים, ודאו שהם אינם ניתנים לקריאה קבוצתית או גלובלית. אם זהו יישום אינטרנט, בדקו כי **https** (TLS) נמצא בשימוש. ישנן בדיקות שלא שווה לעשות (כי הן קשות מדי לעשייה), אבל אפילו כמה בדיקות שפיות (sanity checks) יכולות לזהות ולמנוע בעיות.

לפעמים משתמשים עשויים להצטרך להשבית אמצעי אבטחה כלשהו. במידת האפשר, הפכו את זה למקרה חריג; משתמשים בדרך כלל לא צריכים לעשות זאת. אם כן, ודאו שהמשתמשים **_יודעים_** שהם משביתים משהו חשוב ומה ההשלכות. לכל הפחות, יש לתעד שזה מסוכן ולמה. במקרים כאלה, זה עשוי להיות חכם לדווח או לפחות לרשום ללוג (log) האיתחול איזה אמצעי אבטחה הושבת, לציין שזה מסוכן, ולציין כיצד להפעיל אותו מחדש.

רוב המערכות הגדולות זקוקות למנגנון כלשהו כדי לקבל מידע קונפיגורציה. ודאו שניתן לסמוך על המקור, אם זה חשוב. לדוגמה, תוכניות **setuid** מקבלות משתני סביבה מיריב פוטנציאלי; תוכניות כאלה צריכות לאמת את משתני הסביבה שהן יאפשרו, לחלץ אותם, למחוק את כל משתני הסביבה ולאחר מכן לאפס רק את הערכים לאלה שהם יכולים לסמוך עליהם.

מערכות מסוימות מנסות להסתמך על *אתחול מאובטח* או מנגנונים דומים כדי להבטיח שרק תוכנה מסוימת תופעל במחשב מסוים. אל תיקחו את המנגנונים האלה ברצינות רבה אם המחשב (כגון טלפון חכם) עשוי להיות נשלט פיזית על ידי תוקף פוטנציאלי. אם לתוקף יש שליטה פיזית על מכשיר, לאותו תוקף יש שליטה מוחלטת על המכשיר. המציאות היא שמערכות אתחול מאובטחות נשברו שוב ושוב; לסמוך על זה שלעולם לא יקרה בעתיד הוא התעלמות מלקחי העבר. עדיף לתכנן את המערכת כך שלא תצטרכו לתת אמון ביישום במכשיר זה, אלא להפעיל תוכנה שיש לסמוך עליה בחומרה הנשלטת על-ידי מישהו שניתן לבטוח בו. מערכות אתחול מאובטחות הן הרבה יותר חזקות אם המערכת נשלטת פיזית על ידי גורם מהימן, כי אז הן פשוט מספקות אמצעי הגנה נוסף עבור זה שנמצא בשליטה פיזית.

תצורה שגויה של אבטחה היא טעות כה נפוצה ביישומי אינטרנט שהיא #6 2017 OWASP Top 10 ו- %5 2021 OWASP Top 10. #19 2021 CWE Top 25 [CWE-276](https://cwe.mitre.org/data/definitions/276.html) מכסה את *הרשאות ברירת מחדל שגויות*.

#### חידון 1.10: כניסות מיוחדות: ברירות מחדל מאובטחות והפעלה מאובטחת

\>\>כדי להקל על השימוש, יש לספק יישומים עם סיסמה ידועה סטנדרטית ולהבהיר בתיעוד כיצד לשנות סיסמה זו. אמת או שקר?<<
...
ממש לא. אם יש סיסמה ידועה סטנדרטית, היא תפורסם מיד ב- World Wide Web, וכל התוקפים ישתמשו בסיסמה זו כאשר ינסו לתקוף מערכות אלה. משתמשים רבים לא יקראו את התיעוד. כדי שיישום יהיה מאובטח, הוא צריך להיות "מאובטח כברירת מחדל"; יישום עם סיסמה מוגדרת מראש ידועה אינו *מאובטח* כברירת מחדל. חלופה אחת תהיה לקבל הנחיה "אנא צור את הסיסמה שלך" כאשר היישום משמש לראשונה.

[הסבר]

## שיקלו זמינות בכל קלט

### שיקלו זמינות בכל קלט מבוא
...
אבל ברגע שמתחילים לשקול זמינות כבעית ניהול סיכונים, הדברים לא כל כך חמורים. אנו רוצים להפחית את הסיכון מהתקפות DoS, כלומר, להפחית את הסבירות או ההשפעה שלהן. באפשרותנו להפחית את הסבירות על-ידי הפיכת ההתקפה לקשה יותר, מסוכנת יותר או עתירת משאבים עבור התוקף.

#### נסו למנוע קלט אשר מוגבר בקלות (Easily Amplified Inputs)

מושג שימושי הוא הרעיון של מינוף (leverage). *"בהקשר של מתקפת DoS, אם לפגיעות יש מינוף גבוה זה אומר שהתוקפים יכולים לצרוך המון ממשאבי השרת שלך עם משאבים מינימליים... ככל שהמינוף גבוה יותר, כך הסיכון גבוה יותר, והסיכוי שאטפל בנושא באופן ישיר גבוה יותר. ככל שהמינוף נמוך יותר, כך גדל הסיכוי שאקבל את הסיכון ו/או אשען על דרכי התמודדות [אחרות] ".* ([*לא כל ההתקפות שוות: הבנה ומניעה של DoS ביישומי אינטרנט*](https://r2c.dev/blog/2020/understanding-and-preventing-dos-in-web-apps/) מאת יעקב קפלן-מוס, 2020)

שיקלו כל סוג של קלט שהתוכנה מקבלת. האם יש דרך כלשהי שבה תוקף יכול לשלוח כמות קטנה מאוד של קלט ולצרוך כמות גדולה של משאבים (למשל, חישוב ו/או פלט)? אלה הם לעתים קרובות סיכון גבוה יותר לזמינות, מכיוון שקלט זה יכול להיות מוגבר בקלות.
...
* שטח אחסון — לדוגמה, קובץ דחוס עשוי להתרחב ולמלא את האחסון.

* מגבלות ביצוע מקבילי — לדוגמה, קלט יכול לגרום לט'רד (thread)/תהליך לפעול באיטיות, ולגרום לתוכנה להגיע למקסימום ביצוע מקבילי (לדוגמה, מספר הליכי משנה, ט'רדים (treads) או חיבורים לבסיס נתונים).

הסיכונים האלה ניתנים להפחתה באמצעות אימות, שכן אז התוקפים צריכים לחשוף קצת מידע על עצמם. באופן כללי, נסו להוריד לפחות את אלה הלא מאומתים, ושקלו לדרוש אימות כלשהו עבור השאר ([*לא כל ההתקפות שוות: הבנה ומניעה של DoS ביישומי אינטרנט*](https://r2c.dev/blog/2020/understanding-and-preventing-dos-in-web-apps/) מאת יעקב קפלן-מוס, 2020).

פתרון חלקי אחד להפחתת רוחב הפס של הרשת הוא *דפדוף, (paging)*. כלומר, במקום להחזיר תוצאה גדולה מאוד, להחזיר תוצאות קטנות יותר בכל פעם. פעולה זו מחייבת את התוקף להגיש בקשות חוזרות ונשנות.

אם לא ניתן למנוע קלט שמוגבר בקלות, נסו לחלק את העומס. לדוגמה, אם מפיצים קבצים גדולים, שיקלו להשתמש ברשת אספקת תוכן (Content Delivery Network, CDN), טורנט או מערכת אחרת מסוג זה. אתרי אינטרנט רבים משתמשים ב-CDN כך שבקשות פשוטות עם תשובות פוטנציאליות גדולות לא יעמיסו על השרתים שלהם.

#### הגבלת קצב

גישה פשוטה לשיפור הזמינות הנמצאת בשימוש נרחב במערכות ברשת היא הגבלת קצב. הגבלת קצב מגבילה את קצב בקשות הקלט (לדוגמה, עבור משתמש נתון, מפתח API או כתובת IP). כל עוד מגבלות הקצב גבוהות יחסית, מגבלות הקצב אינן משפיעות באופן משמעותי על השימוש הרגיל, והן יכולות להפוך התקפות DoS של על מערכת יחידה להרבה פחות יעילות. במקרים מסוימים, מגבלות קצב יכולות אפילו לספק אמצעי נגד חלקי נגד התקפות DDoS (מכיוון שהן עשויות להפחית את היעילות של המערכת התוקפת). הגבלת קצב גם מונעת כמה בעיות מקריות.

שימו לב שאם תאלצו את התוקפים להגיש בקשות רבות (למשל, באמצעות דיפדוף), התוקף עלול להתחיל להגיע למגבלות הקצב.

הגבלת קצב אינה פתרון מלא, אך זוהי גישה קלה וזולה המגדילה את העלויות והמאמצים עבור התוקפים.
