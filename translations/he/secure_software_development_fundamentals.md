...
2. **גישור הרשאות מלא (המכונה אי-עקיפה)**<br>כל ניסיון גישה חייב להיבדק; מקם את המנגנון כך שלא ניתן יהיה לערער עליו. מילה נרדפת למטרה זו היא אי-עקיפה.

3. **מנגנון חסכוני (המכונה פשטות)**<br>המערכת, ובמיוחד החלק שהאבטחה תלויה בו, צריכה להיות פשוטה וקטנה ככל האפשר.
...
5. **אל-כשל כברירת מחדל**<br>התקנת ברירת המחדל צריכה להיות ההתקנה המאובטחת. אם לא בטוח שצריך לאפשר משהו, אל תאפשר אותו.
